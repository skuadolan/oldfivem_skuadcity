...
CREATE DATABASE IF NOT EXISTS `db_skuadcity` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `db_skuadcity`;
...
-- Dumping data for table db_skuadcity.addon_account: ~6 rows (approximately)
...
-- Dumping data for table db_skuadcity.addon_account_data: ~5 rows (approximately)
...
-- Dumping data for table db_skuadcity.addon_inventory: ~5 rows (approximately)
...
-- Dumping data for table db_skuadcity.datastore: ~4 rows (approximately)
...
-- Dumping data for table db_skuadcity.datastore_data: ~4 rows (approximately)
...
-- Dumping data for table db_skuadcity.items: ~32 rows (approximately)
...
-- Dumping data for table db_skuadcity.jobs: ~13 rows (approximately)
...
-- Dumping data for table db_skuadcity.job_grades: ~31 rows (approximately)
...
-- Dumping data for table db_skuadcity.licenses: ~0 rows (approximately)
...
-- Dumping data for table db_skuadcity.shops: ~6 rows (approximately)
...
-- Dumping structure for table db_skuadcity.society_moneywash
...
-- Dumping data for table db_skuadcity.society_moneywash: ~0 rows (approximately)
...
-- Dumping structure for table db_skuadcity.user_parkings
...
-- Dumping data for table db_skuadcity.user_parkings: ~0 rows (approximately)
...
-- Dumping data for table db_skuadcity.weashops: ~40 rows (approximately)
