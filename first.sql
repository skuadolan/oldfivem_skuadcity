...
-- Dumping data for table skuadcity.items: ~80 rows (approximately)
REPLACE INTO `items` (`name`, `label`, `weight`, `rare`, `can_remove`, `limit`, `price`) VALUES
	('accu', 'Batre Aki', 1, 0, 1, 10, 100),
	('alcohol', 'Alkohol', 0, 0, 0, 10, NULL),
	('alive_chicken', 'Ayam Hidup', 1, 0, 1, 20, 0),
	('alumunium', 'Alumunium', 0, 0, 0, 10, NULL),
	('antibiotics', 'Antibiotik', 0, 0, 0, 10, NULL),
	...
	('gauze', 'Kain Kasa', 0, 0, 0, 10, NULL),
	('gazbottle', 'Botol Gas', 1, 0, 1, 10, 0),
	('getah_karet', 'Getah Karet', 0, 0, 0, 10, NULL),
	('glue', 'Lem', 0, 0, 0, 10, NULL),
	('gold', 'Emas', 1, 0, 1, 21, 0),
	('gps', 'Peta', 1, 0, 1, 5, 100),
	('gunpowder', 'Bubuk Misiu', 1, 0, 1, 30, 100),
	('hands_glove', 'Sarung Tangan', 0, 0, 0, 10, NULL),
	('HeavyArmor', 'Heavy Body Armor', 1, 0, 1, 5, 0),
	('iron', 'Besi', 1, 0, 1, 42, 0),
	('kanebo', 'Kanebo', 0, 0, 0, 10, NULL),
	('kertas_bungkus', 'Kertas Bungkus', 0, 0, 0, 10, NULL),
	...
	('oil', 'Oli', 0, 0, 0, 10, NULL),
	('packaged_chicken', 'Ayam Siap Jual', 1, 0, 1, 100, 0),
	('packaged_plank', 'Papan Kayu', 1, 0, 1, 100, 0),
	('papper', 'Kertas', 0, 0, 0, 10, NULL),
	('petrol', 'Minyak Mentah', 1, 0, 1, 24, 0),
	('petrol_raffin', 'Minyak Bersih', 1, 0, 1, 24, 0),
	('phone', 'Handphone', 1, 0, -1, 5, 100),
	('plastik', 'Plastik', 0, 0, 0, 10, NULL),
	('potassium_nitrate', 'Kalium Nitrat', 0, 0, 0, 10, NULL),
	('radio', 'Radio', 1, 0, -1, 5, 100),
	('repairkit', 'Alat - alat', 1, 0, 1, 10, 100),
	('rubber', 'Karet', 0, 0, 0, 10, NULL),
	('screwdriver', 'Obeng', 0, 0, 0, 10, NULL),
	('selongsong', 'Selongsong', 0, 0, 0, 10, NULL),
	('slaughtered_chicken', 'Ayam Potong', 1, 0, 1, 20, 0),
	('stainless_steel', 'Stainless Steel', 1, 0, 1, 30, 100),
	('sterile_gloves', 'Sarung Tangan Steril', 0, 0, 0, 10, NULL),
	('stone', 'Batu', 1, 0, 1, 7, 0),
	('sulfur', 'Belerang', 0, 0, 0, 10, NULL),
	...
	('workshop_key', 'Kunci Bengkel', 0, 0, 0, 10, NULL),
