...
exports.start = function(SETUP) {
  ...
  const UpdateEmbed = function() {
    ...
    .setAuthor("SKUAD CITY Server Status", "https://dianadi021.github.io/assets/content/icon/skd.png")
    .setColor(0x2894C2)
    .setFooter(TICK_N % 2 === 0 ? '⚪ SKUAD CITY' : '⚫ SKUAD CITY')
    .setTimestamp(new Date())
    .addField('\n\u200b\nJoin Server?','**Website**: skuad.club\n **FiveM**: connect skuad.club\n **Teamspeak**: skuad, skuadcity\n\u200b\n',false)
    if (STATUS !== undefined)
    {
  ...
  bot.on('ready',() => {
    ...
    bot.user.setActivity('SKUAD CITY',{'url':'http://skuad.club/','type':'WATCHING'});
  ...
  bot.on('message', async function (msg) {
    if (msg.channel.id === '778367422222565386') {
