					...
					ESX.TriggerServerCallback('esx_atmRobbery:getHackerDevice', function(hackerDevice)
						if hackerDevice then
							...
							if Config.PoliceNotfiyEnabled == true then
								...
								local PlayerCoords = { x = playerPos.x, y = playerPos.y, z = playerPos.z }
								TriggerServerEvent('esx_addons_gcphone:startCall', 'police', 'Active ATM robbery', PlayerCoords, {

									PlayerCoords = { x = playerPos.x, y = playerPos.y, z = playerPos.z },
								})
							end
