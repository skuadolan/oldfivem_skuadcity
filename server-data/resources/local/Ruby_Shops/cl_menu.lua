		...
		if MenuActuel == v.MenuId then
			...
			while ShopActif do
	        	...
	        	if RageUI.Visible(mainMenu) then
					...
					RageUI.Button("Price: ", nil, {LeftBadge = nil,RightBadge = nil,RightLabel = "~g~".._prix * _quantite.."$"}, true, function(Hovered, Active, Selected)end)

					RageUI.Button("Quantity: ", nil, {LeftBadge = nil,RightBadge = nil,RightLabel = "~g~".._quantite}, true, function(Hovered, Active, Selected)
						if Selected then
							SelectQuantite()
						end
					end)
