		...
		if distance < maxDistance then
			...
			if isAuthorized then
				if doorID.locked then
					displayText = "[E] - ~r~Terkunci"
				elseif not doorID.locked then
					displayText = "[E] - ~g~Terbuka"
				end
			elseif not isAuthorized then
				if doorID.locked then
					if doorID.text then
						displayText = " ~r~Terkunci " .. doorID.text
					else
						displayText = " ~r~Terkunci "
					end
				elseif not doorID.locked then
					displayText = " ~g~Terbuka "
				end
			end
