...
if Config.EnableCommands then
	ESX.RegisterCommand('char', 'user', function(xPlayer, args, showError)
		if xPlayer and xPlayer.getName() then
			TriggerClientEvent('skd_cSide:forServerNotify', -1, 'inform', _U('active_character', xPlayer.getName()))
			--xPlayer.showNotification(_U('active_character', xPlayer.getName()))
		else
			TriggerClientEvent('skd_cSide:forServerNotify', -1, 'error', _U('error_active_character'))
	...
	ESX.RegisterCommand('chardel', 'user', function(xPlayer, args, showError)
		if xPlayer and xPlayer.getName() then
			if Config.UseDeferrals then
				...
				TriggerClientEvent('skd_cSide:forServerNotify', -1, 'success', _U('deleted_character'))
			...
			TriggerClientEvent('skd_cSide:forServerNotify', -1, 'error', _U('error_delete_character'))
...
if Config.EnableDebugging then
	ESX.RegisterCommand('xPlayerGetFirstName', 'user', function(xPlayer, args, showError)
		if xPlayer and xPlayer.get('firstName') then
			TriggerClientEvent('skd_cSide:forServerNotify', -1, 'inform', _U('return_debug_xPlayer_get_first_name', xPlayer.get('firstName')))
			--xPlayer.showNotification(_U('return_debug_xPlayer_get_first_name', xPlayer.get('firstName')))
		else
			TriggerClientEvent('skd_cSide:forServerNotify', -1, 'error', _U('error_debug_xPlayer_get_first_name'))
	...
	ESX.RegisterCommand('xPlayerGetLastName', 'user', function(xPlayer, args, showError)
		if xPlayer and xPlayer.get('lastName') then
			TriggerClientEvent('skd_cSide:forServerNotify', -1, 'inform', _U('return_debug_xPlayer_get_last_name', xPlayer.get('lastName')))
			--xPlayer.showNotification(_U('return_debug_xPlayer_get_last_name', xPlayer.get('lastName')))
		else
			TriggerClientEvent('skd_cSide:forServerNotify', -1, 'error', _U('error_debug_xPlayer_get_last_name'))
	...
	ESX.RegisterCommand('xPlayerGetFullName', 'user', function(xPlayer, args, showError)
		if xPlayer and xPlayer.getName() then
			TriggerClientEvent('skd_cSide:forServerNotify', -1, 'inform', _U('return_debug_xPlayer_get_full_name', xPlayer.getName()))
			--xPlayer.showNotification(_U('return_debug_xPlayer_get_full_name', xPlayer.getName()))
		else
			TriggerClientEvent('skd_cSide:forServerNotify', -1, 'error', _U('error_debug_xPlayer_get_full_name'))
	...
	ESX.RegisterCommand('xPlayerGetSex', 'user', function(xPlayer, args, showError)
		if xPlayer and xPlayer.get('sex') then
			TriggerClientEvent('skd_cSide:forServerNotify', -1, 'inform', U('return_debug_xPlayer_get_sex', xPlayer.get('sex')))
			--xPlayer.showNotification(_U('return_debug_xPlayer_get_sex', xPlayer.get('sex')))
		else
			TriggerClientEvent('skd_cSide:forServerNotify', -1, 'error', _U('error_debug_xPlayer_get_sex'))
	...
	ESX.RegisterCommand('xPlayerGetDOB', 'user', function(xPlayer, args, showError)
		if xPlayer and xPlayer.get('dateofbirth') then
			TriggerClientEvent('skd_cSide:forServerNotify', -1, 'inform', _U('return_debug_xPlayer_get_dob', xPlayer.get('dateofbirth')))
			--xPlayer.showNotification(_U('return_debug_xPlayer_get_dob', xPlayer.get('dateofbirth')))
		else
			TriggerClientEvent('skd_cSide:forServerNotify', -1, 'error', _U('error_debug_xPlayer_get_dob'))
	...
	ESX.RegisterCommand('xPlayerGetHeight', 'user', function(xPlayer, args, showError)
		if xPlayer and xPlayer.get('height') then
			TriggerClientEvent('skd_cSide:forServerNotify', -1, 'inform', _U('return_debug_xPlayer_get_height', xPlayer.get('height')))
			--xPlayer.showNotification(_U('return_debug_xPlayer_get_height', xPlayer.get('height')))
		else
			TriggerClientEvent('skd_cSide:forServerNotify', -1, 'error', _U('error_debug_xPlayer_get_height'))
