Locales['en'] = {
  ...
  ['noammo'] = 'Tidak cukup!',
  ['gave_item'] = 'Memberikan %sx %s ke %s',
  ['received_item'] = 'Menerima %sx %s dari %s',
  ['gave_weapon'] = 'Memberikan %s ke %s',
  ['gave_weapon_ammo'] = 'Memberikan %sx %s untuk %s ke %s',
  ['gave_weapon_withammo'] = 'Memberikan %s dengan %sx %s ke %s',
  ['gave_weapon_hasalready'] = '%s sudah memiliki %s',
  ['gave_weapon_noweapon'] = '%s tidak memiliki senjata itu',
  ['received_weapon'] = 'Diterima %s dari %s',
  ['received_weapon_ammo'] = 'Diterima %sx %s untuk %s Anda dari %s',
  ['received_weapon_withammo'] = 'Diterima %s dengan %sx %s dari %s',
  ['received_weapon_hasalready'] = '%s telah mencoba memberi Anda %s, tetapi Anda sudah memiliki senjata ini',
  ['received_weapon_noweapon'] = '%s telah mencoba memberi Anda amunisi untuk %s, tetapi Anda tidak memiliki senjata ini',
  ['gave_account_money'] = 'Memberikan Rp.%s (%s) ke %s',
  ['received_account_money'] = 'Menerima Rp.%s (%s) dari %s',
  ['amount_invalid'] = 'Jumlah tidak valid',
  ['players_nearby'] = 'Tidak ada Pemain terdekat',
  ['ex_inv_lim'] = 'Tidak dapat melakukan tindakan, melebihi berat maksimum %s',
  ['imp_invalid_quantity'] = 'Tidak dapat melakukan tindakan, jumlahnya tidak sah',
  ['imp_invalid_amount'] = 'Tidak dapat melakukan tindakan, jumlahnya tidak sah',
  ['threw_standard'] = 'Melempar %sx %s',
  ['threw_account'] = 'Melempar Rp.%s %s',
  ['threw_weapon'] = 'Melempar %s',
  ['threw_weapon_ammo'] = 'Melempar %s dengan %sx %s',
  ['threw_weapon_already'] = 'Anda telah memiliki senjata ini',
  ['threw_cannot_pickup'] = 'Persediaan penuh, Tidak dapat diambil!',
  ...
  -- Commands
  ['command_car'] = 'Buat kendaraan',
  ['command_car_car'] = 'Model kendaraan atau hash',
  ['command_cardel'] = 'Singkirkan kendaraan di sekitar',
  ['command_cardel_radius'] = 'Hapus semua kendaraan dalam radius yang ditentukan',
  ['command_clear'] = 'Hapus teks obrolan',
  ['command_clearall'] = 'Hapus teks obrolan untuk semua pemain',
  ['command_clearinventory'] = 'Hapus Semua item dari Inventaris Pemain',
  ['command_clearloadout'] = 'Hapus Semua senjata dari Pemuatan Pemain',
  ['command_giveaccountmoney'] = 'Berikan Uang ke Akun tertentu',
  ['command_giveaccountmoney_account'] = 'Akun untuk ditambahkan',
  ['command_giveaccountmoney_amount'] = 'Jumlah untuk ditambahkan',
  ['command_giveaccountmoney_invalid'] = 'Nama Akun Tidak Valid',
  ['command_giveitem'] = 'Berikan item kepada Pemain',
  ['command_giveitem_item'] = 'Nama barang',
  ['command_giveitem_count'] = 'Kuantitas',
  ['command_giveweapon'] = 'Berikan pemain senjata',
  ['command_giveweapon_weapon'] = 'Nama senjata',
  ['command_giveweapon_ammo'] = 'Jumlah Amunisi',
  ['command_giveweapon_hasalready'] = 'Pemain sudah memiliki senjata ini',
  ['command_giveweaponcomponent'] = 'Berikan komponen senjata ke pemain',
  ['command_giveweaponcomponent_component'] = 'Nama komponen',
  ['command_giveweaponcomponent_invalid'] = 'Komponen senjata tidak valid',
  ['command_giveweaponcomponent_hasalready'] = 'Pemain sudah memiliki komponen senjata ini',
