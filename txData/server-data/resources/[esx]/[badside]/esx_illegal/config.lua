...
Config.CircleZones = {
	...
	WeedProcessing = {coords = vector3(592.03, -3280.48, 6.07), blimpcoords = vector3(592.03, -3280.48, 6.07), name = _U('blip_weedprocessing'), color = 25, sprite = 496, radius = 0.0, enabled = true},
