Locales ['en'] = {
  ...
  ['license_bought_fail'] = 'you cannot afford a ~b~%s~s~!',
  ...
  ['licenseshop_prompt'] = 'tekan ~INPUT_CONTEXT~ to open the ~g~License Shop~s~.',
  ...
  -- teleport
  ['teleport_enter'] = 'tekan ~g~E ~w~to Enter.',
}