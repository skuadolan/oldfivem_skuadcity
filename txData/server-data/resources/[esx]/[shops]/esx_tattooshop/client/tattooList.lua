Config.TattooList = {
	...
	mpbusiness_overlays = {
		{nameHash = 'MP_Buis_M_Neck_000', addedX = 0.3, addedY=0.2,addedZ=0.5,rotZ = 119.4, price = 150},
		{nameHash = 'MP_Buis_M_Neck_001', addedX = 0.3, addedY=-0.2,addedZ=0.7,rotZ = 56.9, price = 150},
		{nameHash = 'MP_Buis_M_Neck_002', addedX = 0.0, addedY=0.3,addedZ=0.6,rotZ = 164.8, price = 150},
		{nameHash = 'MP_Buis_M_Neck_003', addedX = -0.3, addedY=-0.2,addedZ=0.6,rotZ = -54.1, price = 150},
		{nameHash = 'MP_Buis_M_LeftArm_000', addedX = 0.3, addedY=0.2,addedZ=0.0,rotZ = 115.5, price = 150},
		{nameHash = 'MP_Buis_M_LeftArm_001', addedX = -0.7, addedY=0.1,addedZ=0.0,rotZ = -68.4, price = 150},
		{nameHash = 'MP_Buis_M_RightArm_000', addedX = 0.3, addedY=-0.7,addedZ=0.5,rotZ = 17.7, price = 150},
		{nameHash = 'MP_Buis_M_RightArm_001', addedX = 0.3, addedY=0.3,addedZ=0.0,rotZ = 145.4, price = 150},
		{nameHash = 'MP_Buis_M_Stomach_000', addedX = 0.7, addedY=0.4,addedZ=0.3,rotZ = 117.3, price = 150},
		{nameHash = 'MP_Buis_M_Chest_000', addedX = 0.7, addedY=0.4,addedZ=0.3,rotZ = 117.3, price = 150},
		{nameHash = 'MP_Buis_M_Chest_001', addedX = 0.7, addedY=0.4,addedZ=0.3,rotZ = 117.3, price = 150},
		{nameHash = 'MP_Buis_M_Back_000', addedX = -0.7, addedY=-0.3,addedZ=0.3,rotZ = -53.6, price = 150},
		{nameHash = 'MP_Buis_F_Chest_000', addedX = 0.5, addedY=0.3,addedZ=0.5,rotZ = 124.9, price = 150},
		{nameHash = 'MP_Buis_F_Chest_001', addedX = 0.7, addedY=0.4,addedZ=0.3,rotZ = 117.3, price = 150},
		{nameHash = 'MP_Buis_F_Chest_002', addedX = 0.7, addedY=0.4,addedZ=0.3,rotZ = 117.3, price = 150},
		{nameHash = 'MP_Buis_F_Stom_000', addedX = 0.7, addedY=0.4,addedZ=0.2,rotZ = 117.3, price = 150},
		{nameHash = 'MP_Buis_F_Stom_001', addedX = 0.7, addedY=0.4,addedZ=0.2,rotZ = 117.3, price = 150},
		{nameHash = 'MP_Buis_F_Stom_002', addedX = 0.7, addedY=0.4,addedZ=0.2,rotZ = 117.3, price = 150},
		{nameHash = 'MP_Buis_F_Back_000', addedX = -0.4, addedY=-0.3,addedZ=0.2,rotZ = 299.8, price = 150},
		{nameHash = 'MP_Buis_F_Back_001', addedX = -0.4, addedY=-0.3,addedZ=0.2,rotZ = 299.8, price = 150},
		{nameHash = 'MP_Buis_F_Neck_000', addedX = 0.3, addedY=-0.4,addedZ=0.6,rotZ = 382.8, price = 150},
		{nameHash = 'MP_Buis_F_Neck_001', addedX = -0.3, addedY=0.3,addedZ=0.7,rotZ = 214.2, price = 150},
		{nameHash = 'MP_Buis_F_RArm_000', addedX = 0.5, addedY=0.0,addedZ=0.0,rotZ = 457.5, price = 150},
		{nameHash = 'MP_Buis_F_LArm_000', addedX = 0.2, addedY=0.4,addedZ=0.0,rotZ = 472.0, price = 150},
		{nameHash = 'MP_Buis_F_LLeg_000', addedX = -0.3, addedY=-0.1,addedZ=-0.7,rotZ = 332.0, price = 150},
		{nameHash = 'MP_Buis_F_RLeg_000', addedX = -0.4, addedY=-0.1,addedZ=-0.7,rotZ = 278.0, price = 150}
	},
	...
	mphipster_overlays = {
		...
		{nameHash = 'FM_Hip_M_Tat_030', addedX = -0.7, addedY=-0.5,addedZ=0.3,rotZ = -63.5, price = 150},
		...
		{nameHash = 'FM_Hip_M_Tat_040', addedX = -0.6, addedY=-0.1,addedZ=-0.7,rotZ = 307.0, price = 150},
	...
	mpbiker_overlays = {
		...
		{nameHash = 'MP_MP_Biker_Tat_015_M', addedX = -0.6, addedY=-0.1,addedZ=-0.7,rotZ = 307.0, price = 150},
		...
		{nameHash = 'MP_MP_Biker_Tat_027_M', addedX = -0.6, addedY=-0.1,addedZ=-0.7,rotZ = 307.0, price = 150},
		...
		{nameHash = 'MP_MP_Biker_Tat_030_M', addedX = -1.1, addedY=0.2,addedZ=0.2,rotZ = -431.1, price = 150},
		...
		{nameHash = 'MP_MP_Biker_Tat_036_M', addedX = -0.6, addedY=-0.1,addedZ=-0.7,rotZ = 307.0, price = 150},
	...
	mpbeach_overlays = {
		...
		{nameHash = 'MP_Bea_M_Lleg_000', addedX = -0.6, addedY=-0.1,addedZ=-0.7,rotZ = 307.0, price = 150},
	...
	mpchristmas2_overlays = {
		...
		{nameHash = 'MP_Xmas2_M_Tat_001', addedX = -0.6, addedY=-0.1,addedZ=-0.7,rotZ = 307.0, price = 150},
	...
	mpgunrunning_overlays = {
		...
		{nameHash = 'MP_Gunrunning_Tattoo_005_M', addedX = -0.6, addedY=-0.1,addedZ=-0.7,rotZ = 307.0, price = 150},
		...
		{nameHash = 'MP_Gunrunning_Tattoo_023_M', addedX = -0.6, addedY=-0.1,addedZ=-0.7,rotZ = 307.0, price = 150},
		...
		{nameHash = 'MP_Gunrunning_Tattoo_030_M', addedX = 0.5, addedY=-0.4,addedZ=-0.5,rotZ = 37.8, price = 150}
	},
	...
	mplowrider2_overlays = {
		...
		{nameHash = 'MP_LR_Tat_029_M', addedX = -0.6, addedY=-0.1,addedZ=-0.7,rotZ = 307.0, price = 150},
		{nameHash = 'MP_LR_Tat_030_M', addedX = -0.5, addedY=-0.5,addedZ=-0.7,rotZ = -25.0, price = 150},
	...
	mplowrider_overlays = {
		...
		{nameHash = 'MP_LR_Tat_007_M', addedX = -0.6, addedY=-0.1,addedZ=-0.7,rotZ = 307.0, price = 150},
