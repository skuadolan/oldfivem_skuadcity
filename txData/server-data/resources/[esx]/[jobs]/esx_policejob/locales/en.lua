Locales['en'] = {
  ...
  ['object_spawner'] = 'Spawn Objek',

  ['id_card'] = 'Id Card',
  ['search'] = 'menggeledah',
  ['handcuff'] = 'memborgol',
  ['uncuff'] = 'membuka borgol',
  ['drag'] = 'menggiring',
  ['put_in_vehicle'] = 'memasukkan paksa',
  ['out_the_vehicle'] = 'mengeluarkan paksa',
  ['fine'] = 'denda',
  ['unpaid_bills'] = 'mengelola denda',
  ['license_check'] = 'mengelola lisensi',
  ['license_revoke'] = 'mencabut lisensi',
  ['license_revoked'] = 'lisensi dicabut!',
  ['licence_you_revoked'] = 'you revoked a ~b~%s~s~ which belonged to ~y~%s~s~',
  ['no_players_nearby'] = 'tidak ada orang!',
  ['being_searched'] = 'anda sedang di geledah polisi',
  -- Vehicle interaction
  ['vehicle_info'] = 'informasi kendaraan',
  ['pick_lock'] = 'membobol kendaraan',
  ['vehicle_unlocked'] = 'kendaraan terbobol',
  ['no_vehicles_nearby'] = 'tidak ada kendaraan',
