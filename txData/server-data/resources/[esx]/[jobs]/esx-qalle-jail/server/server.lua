				...
				if args[3] ~= nil then
					GetRPName(jailPlayer, function(Firstname, Lastname)
						TriggerClientEvent('chat:addMessage', -1, {
							template = '<div class="chat-message-ems"><b>BERITA PENJARA | {0}: </b> {1}</div>',
							args = { Firstname .. " " .. Lastname .. " DIPENJARA SELAMA " .. jailTime .. " BULAN KARENA: " .. args[3] }
						})
...
AddEventHandler("esx-qalle-jail:jailPlayer", function(targetSrc, jailTime, jailReason)
	...
	GetRPName(targetSrc, function(Firstname, Lastname)
		TriggerClientEvent('chat:addMessage', -1, {
			template = '<div class="chat-message-ems"><b>BERITA PENJARA | {0}</div>',
			args = { Firstname .. " " .. Lastname .. " DIPENJARA SELAMA " .. jailTime .. " BULAN KARENA: " .. jailReason }
		})
