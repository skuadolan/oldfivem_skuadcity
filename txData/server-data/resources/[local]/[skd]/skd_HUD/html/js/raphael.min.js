...
(function (n) {
  var o = '0.4.2',
    ...
    t = function (n, f) {
      ...
      var k = u,
        ...
        h = [],
        b = r;
      for (r = n, i = 0, o = 0, p = s.length; o < p; o++)
        'zIndex' in s[o] && (l.push(s[o].zIndex), s[o].zIndex < 0 && (y[s[o].zIndex] = s[o]));
      for (l.sort(c); l[a] < 0; ) if (((e = y[l[a++]]), h.push(e.apply(f, v)), i)) return (i = w), h;
      for (o = 0; o < p; o++)
        if (((e = s[o]), 'zIndex' in e))
          if (e.zIndex == l[a]) {
            if ((h.push(e.apply(f, v)), i)) break;
            do if ((a++, (e = y[l[a]]), e && h.push(e.apply(f, v)), i)) break;
            while (e);
          } else y[e.zIndex] = e;
        else if ((h.push(e.apply(f, v)), i)) break;
      return (i = w), (r = b), h.length ? h : null;
    };
  t._events = u;
  t.listeners = function (n) {
    for (var a = n.split(f), t = u, i, v, o, e, p, h, c = [t], l = [], r = 0, y = a.length; r < y; r++) {
      for (h = [], e = 0, p = c.length; e < p; e++)
        for (t = c[e].n, v = [t[a[r]], t[s]], o = 2; o--; ) (i = v[o]), i && (h.push(i), (l = l.concat(i.f || [])));
      c = h;
    }
    return l;
  };
  t.on = function (n, t) {
    ...
    for (e = n.split(f), i = u, r = 0, o = e.length; r < o; r++)
      (i = i.n), (i = (i.hasOwnProperty(e[r]) && i[e[r]]) || (i[e[r]] = { n: {} }));
  ...
  t.off = t.unbind = function (n, i) {
    ...
    for (a = n.split(f), l = [u], c = 0, p = a.length; c < p; c++)
      for (o = 0; o < l.length; o += v.length - 2) {
        if (((v = [o, 1]), (r = l[o].n), a[c] != s)) r[a[c]] && v.push(r[a[c]]);
        else for (h in r) r[e](h) && v.push(r[h]);
        l.splice.apply(l, v);
      }
    for (c = 0, p = l.length; c < p; c++)
      for (r = l[c]; r.n; ) {
        if (i) {
          ...
          for (h in r.n)
            if (r.n[e](h) && r.n[h].f) {
              for (y = r.n[h].f, o = 0, w = y.length; o < w; o++)
                if (y[o] == i) {
                  y.splice(o, 1);
                  break;
                }
  ...
  (function (n, t) {
    ...
    function i(n) {
      var r, u;
      return i.is(n, 'function')
        ? ai
          ? n()
          : t.on('raphael.DOMload', n)
        : i.is(n, tt)
        ? i._engine.create[v](i, n.splice(0, 3 + i.is(n[0], p))).add(n)
        : ((r = Array.prototype.slice.call(arguments, 0)),
          i.is(r[r.length - 1], 'function')
            ? ((u = r.pop()),
              ai
    ...
    function it(n, t, i) {
      function r() {
        ...
        return f[a](u)
          ? (sf(e, u), i ? i(f[u]) : f[u])
          : (e.length >= 1e3 && delete f[e.shift()], e.push(u), (f[u] = n[v](t, o)), i ? i(f[u]) : f[u]);
      }
      return r;
    }
    function oi() {
        ...
        (i = [
          ...
          t
            ? r
              ? u - 4 == r
                ? (i[3] = { x: +n[0], y: +n[1] })
                : u - 2 == r && ((i[2] = { x: +n[0], y: +n[1] }), (i[3] = { x: +n[2], y: +n[3] }))
              : (i[0] = { x: +n[u - 2], y: +n[u - 1] })
            : u - 4 == r
            ? (i[3] = i[2])
            : r || (i[0] = { x: +n[r], y: +n[r + 1] }),
    ...
    function vt(n, t, i, r, f, e, o, s, h) {
      ...
      h = h > 1 ? 1 : h < 0 ? 0 : h;
      var l = h / 2,
        w = [-0.1252, 0.1252, -0.3678, 0.3678, -0.5873, 0.5873, -0.7699, 0.7699, -0.9041, 0.9041, -0.9816, 0.9816],
        b = [0.2491, 0.2491, 0.2335, 0.2335, 0.2032, 0.2032, 0.1601, 0.1601, 0.1069, 0.1069, 0.0472, 0.0472],
        a = 0;
      for (c = 0; c < 12; c++) {
        var v = l * w[c] + l,
          y = kr(v, n, i, f, o),
    ...
    function cf(n, t, i, r, u, f, e, o, s) {
      if (!(s < 0) && !(vt(n, t, i, r, u, f, e, o) < s)) {
        for (var a = 1, l = a / 2, h = a - l, c = vt(n, t, i, r, u, f, e, o, h); y(c - s) > 0.01; )
          (l /= 2), (h += (c < s ? 1 : -1) * l), (c = vt(n, t, i, r, u, f, e, o, h));
        return h;
      }
    }
    ...
    function di(n, t, r) {
      ...
      var et = vt.apply(0, n),
        ...
        rt = {},
        it = r ? 0 : [];
      for (u = 0; u < p + 1; u++) (h = i.findDotsAtSegment.apply(i, n.concat(u / p))), nt.push({ x: h.x, y: h.y, t: u / p });
      for (u = 0; u < w + 1; u++) (h = i.findDotsAtSegment.apply(i, t.concat(u / w))), tt.push({ x: h.x, y: h.y, t: u / w });
      for (u = 0; u < p; u++)
        for (c = 0; c < w; c++) {
          var e = nt[u],
            a = nt[u + 1],
            s = tt[c],
            v = tt[c + 1],
            b = y(a.x - e.x) < 0.001 ? 'y' : 'x',
            k = y(v.x - s.x) < 0.001 ? 'y' : 'x',
            f = lf(e.x, e.y, a.x, a.y, s.x, s.y, v.x, v.y);
          if (f) {
            ...
            d >= 0 && d <= 1.001 && g >= 0 && g <= 1.001 && (r ? it++ : it.push({ x: f.x, y: f.y, t1: l(d, 1), t2: l(g, 1) }));
          }
        }
      return it;
    }
    function gi(n, t, r) {
      ...
      for (n = i._path2curve(n), t = i._path2curve(t), y = r ? 0 : [], p = 0, nt = n.length; p < nt; p++)
        if (((a = n[p]), a[0] == 'M')) (e = b = a[1]), (o = k = a[2]);
        else
          for (
            a[0] == 'C' ? ((c = [e, o].concat(a.slice(1))), (e = c[6]), (o = c[7])) : ((c = [e, o, e, o, b, k, b, k]), (e = b), (o = k)),
              w = 0,
              tt = t.length;
            w < tt;
            w++
          )
            if (((v = t[w]), v[0] == 'M')) (s = d = v[1]), (h = g = v[2]);
            else if (
              (v[0] == 'C' ? ((l = [s, h].concat(v.slice(1))), (s = l[6]), (h = l[7])) : ((l = [s, h, s, h, d, g, d, g]), (s = d), (h = g)),
              (u = di(c, l, r)),
              r)
            )
              y += u;
    ...
    function ht(n, t, i, r, u, f) {
      n != null
        ? ((this.a = +n), (this.b = +t), (this.c = +i), (this.d = +r), (this.e = +u), (this.f = +f))
    ...
    function kt(n, r, u, e, o, c) {
      ...
      var it,
        ...
        k = {};
      if (e) {
        for (v = 0, et = f.length; v < et; v++)
          if (((nt = f[v]), nt.el.id == r.id && nt.anim == n)) {
            nt.percent != u ? (f.splice(v, 1), (pt = 1)) : (ot = nt);
            r.attr(nt.totalOrigin);
            break;
          }
      } else e = +g;
      for (v = 0, et = n.percents.length; v < et; v++)
      ...
      if (it) {
        if (ot) (ot.initstatus = e), (ot.start = new Date() - ot.ms * e);
          ...
          for (l in it)
            if (it[a](l) && (wi[a](l) || r.paper.customAttributes[a](l))) {
              y[l] = r.attr(l);
              y[l] == null && (y[l] = bu[l]);
              g[l] = it[l];
              switch (wi[l]) {
                ...
                case 'colour':
                  y[l] = i.getRGB(y[l]);
                  at = i.getRGB(g[l]);
                  k[l] = { r: (at.r - y[l].r) / w, g: (at.g - y[l].g) / w, b: (at.b - y[l].b) / w };
                  break;
                case 'path':
                  for (dt = wt(y[l], g[l]), ii = dt[1], y[l] = dt[0], k[l] = [], v = 0, et = y[l].length; v < et; v++)
                    for (k[l][v] = [0], tt = 1, vt = y[l][v].length; tt < vt; tt++) k[l][v][tt] = (ii[v][tt] - y[l][v][tt]) / w;
                  break;
                case 'transform':
                  if (((gt = r._), (yt = yf(gt[l], g[l])), yt))
                    for (y[l] = yt.from, g[l] = yt.to, k[l] = [], k[l].real = !0, v = 0, et = y[l].length; v < et; v++)
                      for (k[l][v] = [y[l][v][0]], tt = 1, vt = y[l][v].length; tt < vt; tt++)
                  ...
                  break;
                case 'csv':
                  if (((st = b(it[l])[ut](vi)), (ct = b(y[l])[ut](vi)), l == 'clip-rect'))
                    for (y[l] = ct, k[l] = [], v = ct.length; v--; ) k[l][v] = (st[v] - y[l][v]) / w;
                  g[l] = st;
                  break;
                default:
                  for (st = [][s](it[l]), ct = [][s](y[l]), k[l] = [], v = r.paper.customAttributes[l].length; v--; )
          ...
          if (
            ...
            f.push(nt),
            e && !ot && !pt && ((nt.stop = !0), (nt.start = new Date() - w * e), f.length == 1))
          )
            return or();
    ...
    var ai,
      vi = /[, ]+/,
      lu = { circle: 1, rect: 1, path: 1, ellipse: 1, text: 1, image: 1 },
      au = /\{(\d+)\}/g,
      a = 'hasOwnProperty',
      r = { doc: document, win: n },
      yi = { was: Object.prototype[a].call(r.win, 'Raphael'), is: r.win.Raphael },
      hr = function () {
      ...
      v = 'apply',
      s = 'concat',
      dt = 'ontouchstart' in r.win || (r.win.DocumentTouch && r.doc instanceof DocumentTouch),
      d = '',
      lt = ' ',
      b = String,
      ut = 'split',
      cr = 'click dblclick mousedown mousemove mouseout mouseover mouseup touchstart touchmove touchend touchcancel'[ut](lt),
      gt = { mousedown: 'touchstart', mousemove: 'touchmove', mouseup: 'touchend' },
      ni = b.prototype.toLowerCase,
      u = Math,
      o = u.max,
      l = u.min,
      y = u.abs,
      ...
      pu = { NaN: 1, Infinity: 1, '-Infinity': 1 },
      wu = /^(?:cubic-)?bezier\(([^,]+),([^,]+),([^,]+),([^\)]+)\)/,
      pi = u.round,
      h = parseFloat,
      st = parseInt,
      lr = b.prototype.toUpperCase,
      bu = (i._availableAttrs = {
        class: '',
        'arrow-end': 'none',
        'arrow-start': 'none',
        blur: 0,
      ...
      ki = (i.mapPath = function (n, t) {
        if (!t) return n;
        var f, e, u, i, o, s, r;
        for (n = wt(n), u = 0, o = n.length; u < o; u++)
          for (r = n[u], i = 1, s = r.length; i < s; i += 2)
            (f = t.x(r[i], r[i + 1])), (e = t.y(r[i], r[i + 1])), (r[i] = f), (r[i + 1] = e);
        return n;
      });
    if (
      ((i._g = r),
      (i.type =
        r.win.SVGAngle || r.doc.implementation.hasFeature('http://www.w3.org/TR/SVG11/feature#BasicStructure', '1.1') ? 'SVG' : 'VML'),
      i.type == 'VML')
    ) {
      if (
        ((ui = r.doc.createElement('div')),
        (ui.innerHTML = '<v:shape adj="1"/>'),
        (fi = ui.firstChild),
        (fi.style.behavior = 'url(#default#VML)'),
        !(fi && typeof fi.adj == 'object'))
      )
        return (i.type = d);
      ui = null;
    }
    ...
    i.is = function (n, t) {
      return ((t = ni.call(t)), t == 'finite')
        ...
        : (t == 'null' && n === null) ||
          (t == typeof n && n !== null) ||
          (t == 'object' && n === Object(n)) ||
          (t == 'array' && Array.isArray && Array.isArray(n)) ||
          vu.call(n).slice(8, -1).toLowerCase() == t;
    };
    ...
    var ei = function (n) {
      ...
      pr = function (n, t, r) {
        if (
          (t == null && i.is(n, 'object') && 'r' in n && 'g' in n && 'b' in n && ((r = n.b), (t = n.g), (n = n.r)),
          t == null && i.is(n, ti))
        ) {
          var u = i.getRGB(n);
          n = u.r;
    ...
    i.color = function (n) {
      var t;
      return (
        i.is(n, 'object') && 'h' in n && 's' in n && 'b' in n
          ? ((t = i.hsb2rgb(n)), (n.r = t.r), (n.g = t.g), (n.b = t.b), (n.hex = t.hex))
          : i.is(n, 'object') && 'h' in n && 's' in n && 'l' in n
          ? ((t = i.hsl2rgb(n)), (n.r = t.r), (n.g = t.g), (n.b = t.b), (n.hex = t.hex))
          : (i.is(n, 'string') && (n = i.getRGB(n)),
            i.is(n, 'object') && 'r' in n && 'g' in n && 'b' in n
              ? ((t = i.rgb2hsl(n)), (n.h = t.h), (n.s = t.s), (n.l = t.l), (t = i.rgb2hsb(n)), (n.v = t.b))
              : ((n = { hex: 'none' }), (n.r = n.g = n.b = n.h = n.s = n.v = n.l = -1))),
        (n.toString = yr),
        n
      );
    };
    ...
    i.rgb2hsl = function (n, t, i) {
      ...
      return (
        ...
        (e = ((e + 360) % 6) / 6),
        (u = (f + s) / 2),
        (h = r == 0 ? 0 : u < 0.5 ? r / (2 * u) : r / (2 - 2 * u)),
        { h: e, s: h, l: u, toString: of }
      );
    };
    ...
    i.getRGB = it(function (n) {
      if (!n || !!((n = b(n)).indexOf('-') + 1)) return { r: -1, g: -1, b: -1, hex: 'none', error: 1, toString: oi };
      ...
      var u,
        ...
        r = n.match(yu);
      return r
        ? (r[2] && ((e = st(r[2].substring(5), 16)), (f = st(r[2].substring(3, 5), 16)), (u = st(r[2].substring(1, 3), 16))),
          r[3] && ((e = st((s = r[3].charAt(3)) + s, 16)), (f = st((s = r[3].charAt(2)) + s, 16)), (u = st((s = r[3].charAt(1)) + s, 16))),
          r[4] &&
            ((t = r[4][ut](bi)),
            (u = h(t[0])),
            t[0].slice(-1) == '%' && (u *= 2.55),
    ...
    i.getColor = function (n) {
      var t = (this.getColor.start = this.getColor.start || { h: 0, s: 1, b: n || 0.75 }),
        i = this.hsb2rgb(t.h, t.s, t.b);
      return (t.h += 0.075), t.h > 1 && ((t.h = 0), (t.s -= 0.2), t.s <= 0 && (this.getColor.start = { h: 0, s: 1, b: t.b })), i.hex;
    };
    ...
    i.parsePathString = function (n) {
      ...
      return n
        ? ((r = et(n)), r.arr)
          ? rt(r.arr)
          : ((u = { a: 7, c: 6, h: 1, l: 2, m: 2, r: 4, q: 4, s: 4, t: 2, v: 1, z: 0 }),
            (t = []),
            i.is(n, tt) && i.is(n[0], tt) && (t = rt(n)),
            t.length ||
              b(n).replace(gu, function (n, i, r) {
                var f = [],
                  e = i.toLowerCase();
                if (
                  ...
                  e == 'm' && f.length > 2 && (t.push([i][s](f.splice(0, 2))), (e = 'l'), (i = i == 'm' ? 'l' : 'L')),
                  e == 'r')
                )
                  t.push([i][s](f));
                else while (f.length >= u[e]) if ((t.push([i][s](f.splice(0, u[e]))), !u[e])) break;
              }),
    ...
    et = function (n) {
      var t = (et.ps = et.ps || {});
      return (
        t[n] ? (t[n].sleep = 100) : (t[n] = { sleep: 100 }),
        setTimeout(function () {
    ...
    i.findDotsAtSegment = function (n, t, i, r, f, e, o, s, h) {
      ...
      return (
        (a > y || v < p) && (g += 180),
        { x: tt, y: it, m: { x: a, y: v }, n: { x: y, y: p }, start: { x: rt, y: ut }, end: { x: ft, y: et }, alpha: g }
      );
    };
    ...
    i.isBBoxIntersect = function (n, t) {
      ...
      return (
        ...
        r(n, t.x, t.y2) ||
        r(n, t.x2, t.y2) ||
        (((n.x < t.x2 && n.x > t.x) || (t.x < n.x2 && t.x > n.x)) && ((n.y < t.y2 && n.y > t.y) || (t.y < n.y2 && t.y > n.y)))
      );
    };
    ...
    var nr = (i.pathBBox = function (n) {
        ...
        for (h = 0, p = n.length; h < p; h++)
          (t = n[h]),
            t[0] == 'M'
              ? ((f = t[1]), (e = t[2]), i.push(f), r.push(e))
              : ((u = tu(f, e, t[1], t[2], t[3], t[4], t[5], t[6])),
        ...
        var a = l[v](0, i),
          ...
          k = w - a,
          d = b - y,
          g = { x: a, y: y, x2: w, y2: b, width: k, height: d, cx: a + k / 2, cy: y + d / 2 };
      ...
      af = (i._pathToRelative = function (n) {
        ...
        var r = [],
          ...
          y = 0;
        for (
          n[0][0] == 'M' && ((o = n[0][1]), (e = n[0][2]), (l = o), (a = e), y++, r.push(['M', o, e])), u = y, p = n.length;
          u < p;
          u++
        ) {
      ...
      dr = (i._pathToAbsolute = function (n) {
        ...
        var o = [],
          ...
          b = 0;
        for (
          n[0][0] == 'M' && ((u = +n[0][1]), (f = +n[0][2]), (l = u), (a = f), b++, (o[0] = ['M', u, f])),
          ...
          } else if (r[0] == 'R') (h = [u, f][s](r.slice(1))), o.pop(), (o = o[s](br(h, w))), (t = ['R'][s](r.slice(-2)));
          else for (c = 0, d = r.length; c < d; c++) t[c] = r[c];
          switch (t[0]) {
            case 'Z':
              u = l;
              f = a;
      ...
      nu = function (n, t, i, r, f, e, o, h, c, l) {
        var at = (k * 120) / 180,
          ...
          w,
          gt;
        if (l) (v = l[0]), (a = l[1]), (rt = l[2]), (ft = l[3]);
        else {
          g = ot(n, t, -et);
          n = g.x;
          t = g.y;
        ...
        for (p = [nt, kt, dt][s](p).join()[ut](','), lt = [], w = 0, gt = p.length; w < gt; w++)
      ...
      tu = it(function (n, t, i, r, f, e, s, h) {
        ...
        return (
          y(p) > '1e12' && (p = 0.5),
          y(w) > '1e12' && (w = 0.5),
          p > 0 && p < 1 && ((a = hi(n, t, i, r, f, e, s, h, p)), d.push(a.x), k.push(a.y)),
          w > 0 && w < 1 && ((a = hi(n, t, i, r, f, e, s, h, w)), d.push(a.x), k.push(a.y)),
          (b = e - 2 * r + t - (h - 2 * e + r)),
          (c = 2 * (r - t) - 2 * (e - r)),
          (g = t - r),
          (p = (-c + u.sqrt(c * c - 4 * b * g)) / 2 / b),
          ...
          p > 0 && p < 1 && ((a = hi(n, t, i, r, f, e, s, h, p)), d.push(a.x), k.push(a.y)),
          w > 0 && w < 1 && ((a = hi(n, t, i, r, f, e, s, h, w)), d.push(a.x), k.push(a.y)),
          { min: { x: l[v](0, d), y: l[v](0, k) }, max: { x: o[v](0, d), y: o[v](0, k) } }
        );
      }),
      wt = (i._path2curve = it(
        function (n, t) {
      ...
      fe = (i._parseDots = it(function (n) {
        ...
        for (t = 1, o = r.length - 1; t < o; t++)
          if (!r[t].offset) {
            for (c = h(r[t - 1].offset || 0), e = 0, u = t + 1; u < o; u++)
              if (r[u].offset) {
                e = r[u].offset;
                break;
              }
      ...
      iu = (i._extractTransform = function (n, t) {
        ...
        if (((e.transform = a || []), a))
          for (w = 0, tt = a.length; w < tt; w++) {
            ...
            l == 't' && o == 3
              ? k
                ? ((it = s.x(0, 0)), (rt = s.y(0, 0)), (h = s.x(r[1], r[2])), (c = s.y(r[1], r[2])), u.translate(h - it, c - rt))
                : u.translate(r[1], r[2])
              : l == 'r'
              ? o == 2
                ? ((f = f || n.getBBox(1)), u.rotate(r[1], f.x + f.width / 2, f.y + f.height / 2), (v += r[1]))
                : o == 4 &&
                  (k ? ((h = s.x(r[2], r[3])), (c = s.y(r[2], r[3])), u.rotate(r[1], h, c)) : u.rotate(r[1], r[2], r[3]), (v += r[1]))
              : l == 's'
              ? o == 2 || o == 3
                ? ((f = f || n.getBBox(1)), u.scale(r[1], r[o - 1], f.x + f.width / 2, f.y + f.height / 2), (y *= r[1]), (p *= r[o - 1]))
                : o == 5 &&
                  (k ? ((h = s.x(r[3], r[4])), (c = s.y(r[3], r[4])), u.scale(r[1], r[2], h, c)) : u.scale(r[1], r[2], r[3], r[4]),
                  (y *= r[1]),
                  (p *= r[2]))
              : l == 'm' && o == 7 && u.add(r[1], r[2], r[3], r[4], r[5], r[6]);
            e.dirtyT = 1;
            n.matrix = u;
          }
        n.matrix = u;
      ...
      yf = (i._equaliseTransform = function (n, t) {
        ...
        for (var l = o(n.length, t.length), s = [], h = [], u = 0, f, c, r, e; u < l; u++) {
          if (
            ...
            (e = t[u] || ru(r)),
            r[0] != e[0] ||
              (r[0].toLowerCase() == 'r' && (r[2] != e[2] || r[3] != e[3])) ||
              (r[0].toLowerCase() == 's' && (r[3] != e[3] || r[4] != e[4])))
          )
            return;
      ...
      (function (n) {
        ...
        n.split = function () {
          ...
          return (
            ...
            (e = -f[0][1]),
            (o = f[1][1]),
            o < 0 ? ((n.rotate = i.deg(u.acos(o))), e < 0 && (n.rotate = 360 - n.rotate)) : (n.rotate = i.deg(u.asin(e))),
        ...
        n.toTransformString = function (n) {
          ...
          return t.isSimple
            ? ((t.scalex = +t.scalex.toFixed(4)),
              ...
              (t.dx || t.dy ? 't' + [t.dx, t.dy] : d) +
                (t.scalex != 1 || t.scaley != 1 ? 's' + [t.scalex, t.scaley, 0, 0] : d) +
                (t.rotate ? 'r' + [t.rotate, 0, 0] : d))
    ...
    c.safari =
      (navigator.vendor == 'Apple Computer, Inc.' && ((bt && bt[1] < 4) || navigator.platform.slice(0, 2) == 'iP')) ||
      (navigator.vendor == 'Google Inc.' && bt && bt[1] < 8)
        ? function () {
    ...
    var pf = function () {
          ...
          ? function (n, t, i, r) {
              ...
              return (
                ...
                dt &&
                  gt[t] &&
                  ((f = function (t) {
                    for (var f = uu(t), e = t, u = 0, o = t.targetTouches && t.targetTouches.length; u < o; u++)
      ...
      tr = function (n) {
        for (
          var f = n.clientX,
            e = n.clientY,
            v = r.doc.documentElement.scrollTop || r.doc.body.scrollTop,
            y = r.doc.documentElement.scrollLeft || r.doc.body.scrollLeft,
            i,
            l = ot.length,
            s,
            o;
          ...
          if (((i = ot[l]), dt && n.touches)) {
            for (s = n.touches.length; s--; )
              if (((o = n.touches[s]), o.identifier == i.el._drag.id)) {
                f = o.clientX;
                e = o.clientY;
      ...
      ir = function (n) {
        ...
        for (var u = ot.length, r; u--; )
          (r = ot[u]), (r.el._drag = {}), t('raphael.drag.end.' + r.el.id, r.end_scope || r.start_scope || r.move_scope || r.el, n);
        ot = [];
      },
      e = (i.el = {});
    for (rr = cr.length; rr--; )
        ...
        i[n] = e[n] = function (t, u) {
          return (
            i.is(t, 'function') &&
              ...
              this.events.push({ name: n, f: t, unbind: df(this.shape || this.node || r.doc, n, t, u || this) })),
            this
          );
        };
        i['un' + n] = e['un' + n] = function (t) {
          for (var r = this.events || [], u = r.length; u--; )
            r[u].name == n && (i.is(t, 'undefined') || r[u].f == t) && (r[u].unbind(), r.splice(u, 1), r.length || delete this.events);
          return this;
        };
      })(cr[rr]);
    e.data = function (n, r) {
      var u = (at[this.id] = at[this.id] || {}),
        f;
    ...
    e.drag = function (n, u, f, e, o, s) {
      function h(h) {
        ...
        if (((this._drag.id = h.identifier), dt && h.touches))
      ...
      return (this._drag = {}), ct.push({ el: this, start: h }), this.mousedown(h), this;
    };
    ...
    e.undrag = function () {
      for (var n = ct.length; n--; )
        ct[n].el == this && (this.unmousedown(ct[n].start), ct.splice(n, 1), t.unbind('raphael.drag.*.' + this.id));
    ...
    e.isPointInside = function (n, t) {
      ...
      return (
        this.attr('transform') && this.attr('transform').length && (r = i.transformPath(r, this.attr('transform'))),
    ...
    e.getBBox = function (n) {
      ...
      return n
        ? ((t.dirty || !t.bboxwt) &&
            ((this.realPath = ri[this.type](this)), (t.bboxwt = nr(this.realPath)), (t.bboxwt.toString = eu), (t.dirty = 0)),
          t.bboxwt)
        : ((t.dirty || t.dirtyT || !t.bbox) &&
            ((t.dirty || !this.realPath) && ((t.bboxwt = 0), (this.realPath = ri[this.type](this))),
            (t.bbox = nr(ki(this.realPath, this.matrix))),
            (t.bbox.toString = eu),
            (t.dirty = t.dirtyT = 0)),
          t.bbox);
    };
    ...
    e.glow = function (n) {
      ...
      var t = {
        ...
        f = this.paper,
        e = f.set(),
        i = this.realPath || ri[this.type](this);
      for (i = this.matrix ? ki(i, this.matrix) : i, r = 1; r < u + 1; r++)
        e.push(
          f
            .path(i)
            .attr({
      ...
      fr = function (n, t) {
        return function (r, u, f) {
          ...
          for (y = 0, p = r.length; y < p; y++) {
            if (((e = r[y]), e[0] == 'M')) (s = +e[1]), (h = +e[2]);
              ...
              if (((a = ur(s, h, e[1], e[2], e[3], e[4], e[5], e[6])), l + a > u)) {
                if (t && !v.start) {
                  if (
                    ((o = ur(s, h, e[1], e[2], e[3], e[4], e[5], e[6], u - l)),
                ...
                if (!n && !t) return (o = ur(s, h, e[1], e[2], e[3], e[4], e[5], e[6], u - l)), { x: o.x, y: o.y, alpha: o.alpha };
              }
              l += a;
              s = +e[5];
              h = +e[6];
          ...
          return (
            ...
            o.alpha && (o = { x: o.x, y: o.y, alpha: o.alpha }),
            o
          );
        };
      },
    ...
    g = i.easing_formulas = {
      ...
      elastic: function (n) {
        return n == !!n ? n : nt(2, -10 * n) * u.sin(((n - 0.075) * 2 * k) / 0.3) + 1;
      },
      bounce: function (n) {
        var r = 7.5625,
          t = 2.75,
        ...
        return (
          n < 1 / t
            ? (i = r * n * n)
            : n < 2 / t
            ? ((n -= 1.5 / t), (i = r * n * n + 0.75))
            : n < 2.5 / t
            ? ((n -= 2.25 / t), (i = r * n * n + 0.9375))
            : ((n -= 2.625 / t), (i = r * n * n + 0.984375)),
          i
        );
      },
    };
    ...
    var f = [],
      ...
      or = function () {
        for (var ft = +new Date(), b = 0, n, v, r, u, g, c, nt, w, ut; b < f.length; b++)
          if (((n = f[b]), !n.el.removed && !n.paused)) {
            var k = ft - n.start,
              h = n.ms,
              et = n.easing,
              o = n.from,
            ...
            if (
              (n.initstatus
                ? ((k = ((n.initstatus * n.anim.top - n.prev) / (n.percent - n.prev)) * h),
                  (n.status = n.initstatus),
                  delete n.initstatus,
                  n.stop && f.splice(b--, 1))
                : (n.status = (n.prev + (n.percent - n.prev) * (k / h)) / n.anim.top),
              !(k < 0))
            )
              if (k < h) {
                v = et(k / h);
                  ...
                  if (o[a](r)) {
                    switch (wi[r]) {
                      ...
                      case 'colour':
                        e =
                          'rgb(' +
                          [sr(pi(o[r].r + v * h * l[r].r)), sr(pi(o[r].g + v * h * l[r].g)), sr(pi(o[r].b + v * h * l[r].b))].join(',') +
                          ')';
                        break;
                      case 'path':
    ...
    e.animateWith = function (n, t, r, u, e, o) {
      ...
      for (c = r instanceof ft ? r : i.animation(r, u, e, o), kt(c, s, c.percents[0], null, s.attr()), h = 0, l = f.length; h < l; h++)
    ...
    e.animate = function (n, t, r, u) {
      ...
      return f.removed
        ? (u && u.call(f), f)
        : ((e = n instanceof ft ? n : i.animation(n, t, r, u)), kt(e, f, e.percents[0], null, f.attr()), f);
    };
    ...
    e.status = function (n, t) {
      ...
      for (e = f.length; r < e; r++)
        if (((i = f[r]), i.el.id == this.id && (!n || i.anim == n))) {
    ...
    e.pause = function (n) {
      for (var i = 0; i < f.length; i++)
        f[i].el.id != this.id ||
          (n && f[i].anim != n) ||
          (t('raphael.anim.pause.' + this.id, this, f[i].anim) !== !1 && (f[i].paused = !0));
      return this;
    };
    e.resume = function (n) {
      for (var r, i = 0; i < f.length; i++)
        f[i].el.id != this.id ||
          (n && f[i].anim != n) ||
          ((r = f[i]), t('raphael.anim.resume.' + this.id, this, r.anim) !== !1 && (delete r.paused, this.status(r.anim, r.status)));
      return this;
    };
    e.stop = function (n) {
      for (var i = 0; i < f.length; i++)
    ...
    yt = function (n) {
      if (((this.items = []), (this.length = 0), (this.type = 'set'), n))
        for (var t = 0, i = n.length; t < i; t++)
          n[t] &&
            (n[t].constructor == e.constructor || n[t].constructor == yt) &&
            ((this[this.items.length] = this.items[this.items.length] = n[t]), this.length++);
    };
    w = yt.prototype;
    w.push = function () {
      for (var n, t, i = 0, r = arguments.length; i < r; i++)
        (n = arguments[i]),
          n &&
            (n.constructor == e.constructor || n.constructor == yt) &&
            ((t = this.items.length), (this[t] = this.items[t] = n), this.length++);
      return this;
    };
    w.pop = function () {
    ...
    w.attr = function (n, t) {
      var r, f, u, e;
      if (n && i.is(n, tt) && i.is(n[0], 'object')) for (r = 0, f = n.length; r < f; r++) this.items[r].attr(n[r]);
      else for (u = 0, e = this.items.length; u < e; u++) this.items[u].attr(n, t);
      return this;
    };
    w.clear = function () {
    ...
    w.animate = function (n, t, r, u) {
      ...
      for (
        u &&
          ...
          h = this.items[--f].animate(o);
        f--;

      )
        this.items[f] && !this.items[f].removed && this.items[f].animateWith(h, o, o), (this.items[f] && !this.items[f].removed) || e--;
      return this;
    };
    ...
    w.getBBox = function () {
      for (var n, t = [], i = [], r = [], u = [], f = this.items.length; f--; )
        this.items[f].removed || ((n = this.items[f].getBBox()), t.push(n.x), i.push(n.y), r.push(n.x + n.width), u.push(n.y + n.height));
      return (
        (t = l[v](0, t)), (i = l[v](0, i)), (r = o[v](0, r)), (u = o[v](0, u)), { x: t, y: i, x2: r, y2: u, width: r - t, height: u - i }
      );
    };
    w.clone = function (n) {
      n = this.paper.set();
          ...
          if (
            ...
            (i.glyphs[r] = {
              ...
              d:
                t.d &&
                'M' +
                  t.d.replace(/[mlcxtrv]/g, function (n) {
                    return { l: 'L', c: 'C', x: 'z', t: 'm', r: 'l', v: 'c' }[n] || 'M';
                  }) +
                  'z',
            }),
            t.k)
          )
            for (e in t.k) t[a](e) && (i.glyphs[r].k[e] = t.k[e]);
      }
      return n;
    };
    c.getFont = function (n, t, r, u) {
      var f, h, o, e, s, c;
      if (
        ((u = u || 'normal'), (r = r || 'normal'), (t = +t || { normal: 400, bold: 700, lighter: 300, bolder: 800 }[t] || 400), i.fonts)
      ) {
        if (((f = i.fonts[n]), !f)) {
    ...
    c.print = function (n, t, r, u, f, e, s, h) {
      ...
      if ((i.is(u, 'string') && (u = this.getFont(u)), u)) {
        ...
        var w = u.face.bbox[ut](vi),
          it = +w[0],
          nt = w[3] - w[1],
          rt = 0,
          ft = +w[1] + (e == 'baseline' ? nt + +u.face.descent : nt / 2);
        for (a = 0, et = v.length; a < et; a++)
          v[a] == '\n'
            ? ((g = 0), (y = 0), (p = 0), (rt += nt * h))
            : ((k = (p && u.glyphs[v[a - 1]]) || {}),
              (y = u.glyphs[v[a]]),
    ...
    c.add = function (n) {
      if (i.is(n, 'array'))
        for (var u = this.set(), r = 0, f = n.length, t; r < f; r++) (t = n[r] || {}), lu[a](t.type) && u.push(this[t.type]().attr(t));
      return u;
    };
    ...
    i.fullfill = (function () {
      var n = /\{([^\}]+)\}/g,
        ...
        i = function (n, i, r) {
          var u = r;
          return (
            i.replace(t, function (n, t, i, r, f) {
              t = t || r;
    ...
    return (
        ...
        if (i.svg) {
          ...
          var n = function (r, f) {
              ...
              if (f) {
                ...
                for (e in f)
                  f[t](e) &&
                    (e.substring(0, 6) == 'xlink:'
                      ? r.setAttributeNS(a, e.substring(6), u(f[e]))
                      : r !== undefined && ((o = u(f[e])), (e !== 'd' || (e === 'd' && o !== 'M,0,0')) && r.setAttribute(e, o)));
              } else
            ...
            it = function (t, r) {
              ...
              if (!a) {
                if (
                  ((r = u(r).replace(i._radial_gradient, function (n, t, i) {
                    if (((w = 'radial'), t && i)) {
                      b = f(t);
                      s = f(i);
                      var r = (s > 0.5) * 2 - 1;
                      d(b - 0.5, 2) + d(s - 0.5, 2) > 0.25 &&
                        (s = c.sqrt(0.25 - d(b - 0.5, 2)) * r + 0.5) &&
                        s != 0.5 &&
                ...
                if (
                  ...
                  t.gradient && l != t.gradient.id && (it.defs.removeChild(t.gradient), delete t.gradient),
                  !t.gradient)
                )
                  for (
                    a = n(w + 'Gradient', { id: l }),
                      ...
                      n(
                        a,
                        w == 'radial' ? { fx: b, fy: s } : { x1: e[0], y1: e[1], x2: e[2], y2: e[3], gradientTransform: t.matrix.invert() }
                      ),
                    ...
                    a.appendChild(n('stop', { offset: p[h].offset ? p[h].offset : h ? '100%' : '0%', 'stop-color': p[h].color || '#fff' }));
              }
              return (
                n(tt, { fill: 'url(#' + l + ')', opacity: 1, 'fill-opacity': 1 }), (g.fill = o), (g.opacity = 1), (g.fillOpacity = 1), 1
              );
            },
            b = function (t) {
              var i = t.getBBox(1);
            ...
            s = function (r, f, s) {
              ...
              if (r.type == 'path') {
                ...
                a == 'open'
                  ? ((v += 2), (y += 2), (nt += 2), (ot = 1), (st = s ? 4 : 1), (c = { fill: 'none', stroke: l.stroke }))
                  : ((st = ot = v / 2), (c = { fill: l.stroke, stroke: 'none' }));
                r._.arrows
                  ? s
                    ? (r._.arrows.endPath && e[r._.arrows.endPath]--, r._.arrows.endMarker && e[r._.arrows.endMarker]--)
                    : (r._.arrows.startPath && e[r._.arrows.startPath]--, r._.arrows.startMarker && e[r._.arrows.startMarker]--)
                  : (r._.arrows = {});
                a != 'none'
                  ? ((b = 'raphael-marker-' + a),
                    (k = 'raphael-marker-' + h + a + v + y),
                    i._g.doc.getElementById(b)
                      ? e[b]++
                      : (ht.defs.appendChild(n(n('path'), { 'stroke-linecap': 'round', d: ft[a], id: b })), (e[b] = 1)),
                    (g = i._g.doc.getElementById(k)),
                    g
                      ? (e[k]++, (tt = g.getElementsByTagName('use')[0]))
                      : ((g = n(n('marker'), { id: k, markerHeight: y, markerWidth: v, orient: 'auto', refX: st, refY: y / 2 })),
                        (tt = n(n('use'), {
                          'xlink:href': '#' + b,
                    ...
                    s
                      ? ((p = r._.arrows.startdx * d || 0), (w = i.getTotalLength(l.path) - it * d))
                      : ((p = it * d), (w = i.getTotalLength(l.path) - (r._.arrows.enddx * d || 0))),
                    (c = {}),
                    (c['marker-' + h] = 'url(#' + k + ')'),
                    (w || p) && (c.d = i.getSubpath(l.path, p, w)),
                    n(ct, c),
                    (r._.arrows[h + 'Path'] = b),
                    (r._.arrows[h + 'Marker'] = k),
                    (r._.arrows[h + 'dx'] = it),
                    (r._.arrows[h + 'Type'] = a),
                    (r._.arrows[h + 'String'] = f))
                  : (s
                      ? ((p = r._.arrows.startdx * d || 0), (w = i.getTotalLength(l.path) - p))
                      : ((p = 0), (w = i.getTotalLength(l.path) - (r._.arrows.enddx * d || 0))),
                    r._.arrows[h + 'Path'] && n(ct, { d: i.getSubpath(l.path, p, w) }),
            ...
            rt = function (t, i, r) {
              if (((i = et[u(i).toLowerCase()]), i)) {
                for (
                  var e = t.attrs['stroke-width'] || '1',
                    s = { round: e, square: e, butt: 0 }[t.attrs['stroke-linecap'] || r['stroke-linecap']] || 0,
                    o = [],
                    f = i.length;
                  f--;
                ...
                if (f[t](v)) {
                  ...
                  switch (v) {
                    ...
                    case 'title':
                      ...
                      d.length && (d = d[0])
                        ? (d.firstChild.nodeValue = e)
                        : ((d = n('title')), (vt = i._g.doc.createTextNode(e)), d.appendChild(vt), h.appendChild(d));
                      break;
                    case 'href':
                    case 'target':
                      g = h.parentNode;
                    ...
                    case 'clip-rect':
                      ...
                      nt.length == 4 &&
                        ...
                        (st = n('rect')),
                        (p.id = i.createUUID()),
                        n(st, { x: nt[0], y: nt[1], width: nt[2], height: nt[3] }),
                        p.appendChild(st),
                        r.paper.defs.appendChild(p),
                        n(h, { 'clip-path': 'url(#' + p.id + ')' }),
                        (r.clip = st));
                      e ||
                        ((at = h.getAttribute('clip-path')),
                        at &&
                          ((ht = i._g.doc.getElementById(at.replace(/(^url\(#|\)$)/g, o))),
                    ...
                    case 'path':
                      r.type == 'path' &&
                        (n(h, { d: e ? (c.path = i._pathToAbsolute(e)) : 'M0,0' }),
                        (r._.dirty = 1),
                        r._.arrows &&
                      ...
                      break;
                    case 'width':
                      if ((h.setAttribute(v, e), (r._.dirty = 1), c.fx)) (v = 'x'), (e = c.x);
                      else break;
                    case 'x':
                    ...
                    case 'cx':
                      ...
                      break;
                    case 'height':
                      if ((h.setAttribute(v, e), (r._.dirty = 1), c.fy)) (v = 'y'), (e = c.y);
                      else break;
                    case 'y':
                    ...
                    case 'cy':
                      ...
                      break;
                    case 'r':
                      r.type == 'rect' ? n(h, { rx: e, ry: e }) : h.setAttribute(v, e);
                      r._.dirty = 1;
                      break;
                    case 'src':
                    ...
                    case 'fill':
                      if (((ct = u(e).match(i._ISURL)), ct)) {
                        ...
                        lt = n('image');
                        p.id = i.createUUID();
                        n(p, { x: 0, y: 0, patternUnits: 'userSpaceOnUse', height: 1, width: 1 });
                      ...
                      if (((w = i.getRGB(e)), w.error)) {
                        ...
                        delete f.gradient,
                          delete c.gradient,
                          !i.is(c.opacity, 'undefined') && i.is(f.opacity, 'undefined') && n(h, { opacity: c.opacity }),
                          !i.is(c['fill-opacity'], 'undefined') &&
                            i.is(f['fill-opacity'], 'undefined') &&
                            n(h, { 'fill-opacity': c['fill-opacity'] });
            ...
            ot = function (r, f) {
              ...
              if (r.type == 'text' && (f[t]('text') || f[t]('font') || f[t]('font-size') || f[t]('x') || f[t]('y'))) {
                var c = r.attrs,
                  s = r.node,
                  w = s.firstChild ? tt(i._g.doc.defaultView.getComputedStyle(s.firstChild, o).getPropertyValue('font-size'), 10) : 10;
                if (f[t]('text')) {
                  for (c.text = f.text; s.firstChild; ) s.removeChild(s.firstChild);
                  for (y = u(f.text).split('\n'), h = [], e = 0, a = y.length; e < a; e++)
                    (l = n('tspan')),
                      e && n(l, { dy: w * ut, x: c.x }),
                  ...
                  for (h = s.getElementsByTagName('tspan'), e = 0, a = h.length; e < a; e++)
                    e ? n(h[e], { dy: w * ut, x: c.x }) : n(h[0], { dy: 0 });
                n(s, { x: c.x, y: c.y });
                r._.dirty = 1;
                p = r._getBBox();
          ...
          i._engine.path = function (t, i) {
            var u = n('path'),
              r;
            return (
              i.canvas && i.canvas.appendChild(u), (r = new h(u, i)), (r.type = 'path'), g(r, { fill: 'none', stroke: '#000', path: t }), r
            );
          };
          ...
          r.scale = function (n, t, i, r) {
            ...
            if (
              ((n = u(n).split(l)),
              n.length - 1 && ((t = f(n[1])), (i = f(n[2])), (r = f(n[3]))),
              (n = f(n[0])),
              t == null && (t = n),
              r == null && (i = r),
              i == null || r == null)
          ...
          r.transform = function (r) {
            ...
            return r == null
              ? u.transform
              : (i._extractTransform(this, r),
                this.clip && n(this.clip, { transform: this.matrix.invert() }),
                this.pattern && b(this),
                this.node && n(this.node, { transform: this.matrix }),
                (u.sx != 1 || u.sy != 1) &&
                  ((f = this.attrs[t]('stroke-width') ? this.attrs['stroke-width'] : 1), this.attr({ 'stroke-width': f })),
                this);
          };
          r.hide = function () {
          ...
          r.attr = function (n, r) {
            ...
            if (r == null && i.is(n, 'string')) {
              ...
              for (a = n.split(l), s = {}, o = 0, h = a.length; o < h; o++)
                (n = a[o]),
                  (s[n] =
                    n in this.attrs
                      ? this.attrs[n]
                      : i.is(this.paper.customAttributes[n], 'function')
                      ? this.paper.customAttributes[n].def
                      : i._availableAttrs[n]);
              return h - 1 ? s : s[a[0]];
            }
          ...
          r.toBack = function () {
            ...
            return this.removed
              ? this
              : ((n = this.node.parentNode), n === null)
              ? this
              : (n.tagName.toLowerCase() == 'a'
                  ? n.parentNode.insertBefore(this.node.parentNode, this.node.parentNode.parentNode.firstChild)
                  : n.firstChild != this.node && n.insertBefore(this.node, this.node.parentNode.firstChild),
            ...
            return (
              +t != 0
                ? ((u = n('filter')),
                  ...
                  (r.attrs.blur = t),
                  (u.id = i.createUUID()),
                  n(f, { stdDeviation: +t || 1.5 }),
                  u.appendChild(f),
                  r.paper.defs.appendChild(u),
                  (r._blur = u),
                  n(r.node, { filter: 'url(#' + u.id + ')' }))
          ...
          i._engine.circle = function (t, i, r, u) {
            var e = n('circle'),
              f;
            return (
              t.canvas && t.canvas.appendChild(e),
              (f = new h(e, t)),
              (f.attrs = { cx: i, cy: r, r: u, fill: 'none', stroke: '#000' }),
              (f.type = 'circle'),
              n(e, f.attrs),
              f
            );
          ...
          i._engine.rect = function (t, i, r, u, f, e) {
            ...
            return (
              ...
              (o = new h(s, t)),
              (o.attrs = { x: i, y: r, width: u, height: f, r: e || 0, rx: e || 0, ry: e || 0, fill: 'none', stroke: '#000' }),
              (o.type = 'rect'),
              n(s, o.attrs),
              o
            );
          ...
          i._engine.ellipse = function (t, i, r, u, f) {
            ...
            return (
              ...
              (e = new h(o, t)),
              (e.attrs = { cx: i, cy: r, rx: u, ry: f, fill: 'none', stroke: '#000' }),
              (e.type = 'ellipse'),
              n(o, e.attrs),
              e
            );
          ...
          i._engine.image = function (t, i, r, u, f, e) {
            var o = n('image'),
              s;
            return (
              n(o, { x: r, y: u, width: f, height: e, preserveAspectRatio: 'none' }),
              o.setAttributeNS(a, 'href', i),
              t.canvas && t.canvas.appendChild(o),
              (s = new h(o, t)),
              (s.attrs = { x: r, y: u, width: f, height: e, src: i }),
              (s.type = 'image'),
              s
            );
          };
          i._engine.text = function (t, r, u, f) {
            ...
            return (
              t.canvas && t.canvas.appendChild(o),
              (e = new h(o, t)),
              (e.attrs = { x: r, y: u, 'text-anchor': 'middle', text: f, font: i._availableAttrs.font, stroke: 'none', fill: '#000' }),
              (e.type = 'text'),
              g(e, e.attrs),
              e
            );
          ...
          i._engine.create = function () {
            var u = i._getContainer.apply(0, arguments),
              t = u && u.container,
              o = u.x,
              s = u.y,
              f = u.width,
            ...
            return (
              ...
              (f = f || 512),
              (e = e || 342),
              n(r, { height: e, version: 1.1, width: f, xmlns: 'http://www.w3.org/2000/svg' }),
              t == 1
                ? ((r.style.cssText = h + 'position:absolute;left:' + o + 'px;top:' + s + 'px'), i._g.doc.body.appendChild(r), (c = 1))
                : ((r.style.cssText = h + 'position:relative'), t.firstChild ? t.insertBefore(r, t.firstChild) : t.appendChild(r)),
              (t = new i._Paper()),
              (t.width = f),
              (t.height = e),
              (t.canvas = r),
          ...
          i._engine.setViewBox = function (t, i, r, u, f) {
            ...
            var o = k(r / this.width, u / this.height),
              e = this.top,
              c = f ? 'xMidYMid meet' : 'xMinYMin',
              s,
              h;
            for (
              t == null
                ? (this._vbSize && (o = 1), delete this._vbSize, (s = '0 0 ' + this.width + w + this.height))
                : ((this._vbSize = o), (s = t + w + i + w + r + w + u)),
                n(this.canvas, { viewBox: s, preserveAspectRatio: c });
              o && e;

            )
              (h = 'stroke-width' in e.attrs ? e.attrs['stroke-width'] : 1),
                e.attr({ 'stroke-width': h }),
                (e._.dirty = 1),
                (e._.dirtyT = 1),
                (e = e.prev);
          ...
          i.prototype.renderfix = function () {
            ...
            r = -t.f % 1;
            (i || r) &&
              (i && ((this._left = (this._left + i) % 1), (u.left = this._left + 'px')),
              r && ((this._top = (this._top + r) % 1), (u.top = this._top + 'px')));
          };
      ...
      (function () {
        ...
        if (i.vml) {
          var h = 'hasOwnProperty',
            ...
            o = ' ',
            u = '',
            nt = { M: 'm', L: 'l', C: 'c', Z: 'x', m: 't', l: 'r', c: 'v', z: 'x' },
            et = /([clmz]),?([^clmz]*)/gi,
            ot = / progid:\S+Blur\([^\)]+\)/g,
            st = /-?[^,\s-]+/g,
            tt = 'position:absolute;left:0;top:0;width:1px;height:1px',
            n = 21600,
            ht = { path: 1, rect: 1, image: 1 },
            ct = { circle: 1, ellipse: 1 },
            lt = function (r) {
              var l = /[ahqstv]/gi,
                a = i._pathToAbsolute,
                v,
                ...
                h,
                p;
              if ((t(r).match(l) && (a = i._path2curve), (l = /[clmz]/g), a == i._pathToAbsolute && !t(r).match(l)))
                return t(r).replace(et, function (t, i, r) {
                  var u = [],
                    o = i.toLowerCase() == 'm',
                    f = nt[i];
                  return (
                    r.replace(st, function (t) {
              ...
              for (c = a(r), v = [], s = 0, w = c.length; s < w; s++) {
                for (y = c[s], f = c[s][0].toLowerCase(), f == 'z' && (f = 'x'), h = 1, p = y.length; h < p; h++)
                  f += e(y[h] * n) + (h != p - 1 ? ',' : u);
                v.push(f);
              }
              return v.join(o);
            ...
            it = function (n, t, r) {
              var u = i.matrix();
              return u.rotate(-n, 0.5, 0.5), { dx: u.x(t, r), dy: u.y(t, r) };
            },
            w = function (t, i, r, u, f, e) {
              var v = t._,
                ...
                a,
                s;
              ((y.visibility = 'hidden'), i && r) &&
                ((c.coordsize = p(d) + o + p(g)),
                (y.rotation = e * (i * r < 0 ? -1 : 1)),
                e && ((a = it(e, u, f)), (u = a.dx), (f = a.dy)),
                i < 0 && (b += 'x'),
                r < 0 && (b += ' y') && (w = -1),
                (y.flip = b),
                (c.coordorigin = u * -d + o + f * -g),
                (h || v.fillsize) &&
                  ((s = c.getElementsByTagName(l)),
                  (s = s && s[0]),
                  c.removeChild(s),
                  h && ((a = it(e, k.x(h[0], h[1]), k.y(h[0], h[1]))), (s.position = a.dx * w + o + a.dy * w)),
          ...
          var rt = function (n, i, r) {
              for (
                var u = t(i).toLowerCase().split('-'), o = r ? 'end' : 'start', f = u.length, s = 'classic', h = 'medium', c = 'medium', e;
                f--;
            ...
            v = function (r, c) {
              ...
              var b = r.node,
                ...
                ui =
                  ...
                  (c.x != v.x ||
                    ...
                    c.ry != v.ry ||
                    c.r != v.r),
                ci = ct[r.type] && (v.cx != c.cx || v.cy != c.cy || v.r != c.r || v.rx != c.rx || v.ry != c.ry),
                p = r;
              for (yt in c) c[h](yt) && (v[yt] = c[yt]);
              if (
                (ui && ((v.path = i._getPath[r.type](r)), (r._.dirty = 1)),
                c.href && (b.href = c.href),
                c.title && (b.title = c.title),
                c.target && (b.target = c.target),
                c.cursor && (it.cursor = c.cursor),
                'blur' in c && r.blur(c.blur),
                ((c.path && r.type == 'path') || ui) &&
                  ((b.path = lt(~t(v.path).toLowerCase().indexOf('r') ? i._pathToAbsolute(v.path) : v.path)),
                  r.type == 'image' && ((r._.fillpos = [v.x, v.y]), (r._.fillsize = [v.width, v.height]), w(r, 1, 1, 0, 0, 0))),
                'transform' in c && r.transform(c.transform),
                ci)
              ) {
                var kt = +v.cx,
                  fi = +v.cy,
              ...
              if (
                ('clip-rect' in c &&
                  ...
                  nt.length == 4 &&
                    ...
                    b.clipRect ||
                      ...
                      (ut.top = 0),
                      (ut.left = 0),
                      (ut.width = r.paper.width + 'px'),
                      (ut.height = r.paper.height + 'px'),
                ...
                (c.opacity != null ||
                  ...
                  c.stroke != null ||
                  c['stroke-width'] != null ||
                  c['stroke-opacity'] != null ||
                  c['fill-opacity'] != null ||
                  c['stroke-dasharray'] != null ||
                  c['stroke-miterlimit'] != null ||
                  c['stroke-linejoin'] != null ||
                  c['stroke-linecap'] != null) &&
                  ((y = b.getElementsByTagName(l)),
                  (si = !1),
                  (y = y && y[0]),
                  y || (si = y = s(l)),
                  r.type == 'image' && c.src && (y.src = c.src),
                  c.fill && (y.on = !0),
                  (y.on == null || c.fill == 'none' || c.fill === null) && (y.on = !1),
                  y.on &&
                    c.fill &&
                    ((pt = t(c.fill).match(i._ISURL)),
                    pt
                      ? (y.parentNode == b && b.removeChild(y),
                        (y.rotate = !0),
                        (y.src = pt[1]),
                        (y.type = 'tile'),
                        (st = r.getBBox(1)),
                        (y.position = st.x + o + st.y),
                        (r._.fillpos = [st.x, st.y]),
                      ...
                      : ((y.color = i.getRGB(c.fill).hex),
                        (y.src = u),
                        (y.type = 'solid'),
                        i.getRGB(c.fill).error &&
                          (p.type in { circle: 1, ellipse: 1 } || t(c.fill).charAt() != 'r') &&
                          at(p, c.fill, y) &&
                          ((v.fill = 'none'), (v.gradient = c.fill), (y.rotate = !1)))),
                  ('fill-opacity' in c || 'opacity' in c) &&
                    ((tt = ((+v['fill-opacity'] + 1 || 2) - 1) * ((+v.opacity + 1 || 2) - 1) * ((+i.getRGB(c.fill).o + 1 || 2) - 1)),
                    (tt = g(k(tt, 0), 1)),
                    (y.opacity = tt),
                    y.src && (y.color = 'none')),
                  b.appendChild(y),
                  (d = b.getElementsByTagName('stroke') && b.getElementsByTagName('stroke')[0]),
                  (dt = !1),
                  d || (dt = d = s('stroke')),
                  ((c.stroke && c.stroke != 'none') ||
                    ...
                    c['stroke-linecap']) &&
                    (d.on = !0),
                  (c.stroke == 'none' || c.stroke === null || d.on == null || c.stroke == 0 || c['stroke-width'] == 0) && (d.on = !1),
                  (gt = i.getRGB(c.stroke)),
                  d.on && c.stroke && (d.color = gt.hex),
                  (tt = ((+v['stroke-opacity'] + 1 || 2) - 1) * ((+v.opacity + 1 || 2) - 1) * ((+gt.o + 1 || 2) - 1)),
                  (et = (f(c['stroke-width']) || 1) * 0.75),
                  (tt = g(k(tt, 0), 1)),
                  c['stroke-width'] == null && (et = v['stroke-width']),
                  c['stroke-width'] && (d.weight = et),
                  et && et < 1 && (tt *= et) && (d.weight = 1),
                  (d.opacity = tt),
                  c['stroke-linejoin'] && (d.joinstyle = c['stroke-linejoin'] || 'miter'),
                  (d.miterlimit = c['stroke-miterlimit'] || 8),
                  c['stroke-linecap'] &&
                    (d.endcap = c['stroke-linecap'] == 'butt' ? 'flat' : c['stroke-linecap'] == 'square' ? 'square' : 'round'),
                ...
                for (
                  it = ti.style,
                    ...
                    p.textpath.string &&
                      (ti.innerHTML = t(p.textpath.string).replace(/</g, '&#60;').replace(/&/g, '&#38;').replace(/\n/g, '<br>')),
            ...
            at = function (n, r, e) {
              ...
              if (
                ((n.attrs.gradient = r),
                (r = t(r).replace(i._radial_gradient, function (n, t, i) {
                  return (
                    (y = 'radial'),
                    t &&
                      i &&
                      ((t = f(t)),
                      (i = f(i)),
                      v(t - 0.5, 2) + v(i - 0.5, 2) > 0.25 && (i = c.sqrt(0.25 - v(t - 0.5, 2)) * ((i > 0.5) * 2 - 1) + 0.5),
                      (p = t + o + i)),
                    u
                  );
                })),
                (r = r.split(/\s*\-\s*/)),
                y == 'linear' && ((l = r.shift()), (l = -f(l)), isNaN(l))) ||
                ((s = i._parseDots(r)), !s)
              )
                return null;
              if (((n = n.shape || n.node), s.length)) {
                ...
                y == 'radial'
                  ? ((e.type = 'gradientTitle'), (e.focus = '100%'), (e.focussize = '0 0'), (e.focusposition = p), (e.angle = 0))
                  : ((e.type = 'gradient'), (e.angle = (270 - l) % 360));
                n.appendChild(e);
              }
              return 1;
            },
          ...
          r.transform = function (r) {
            ...
            var s = this.matrix.clone(),
              ...
              c = this.node,
              f,
              v = ~t(this.attrs.fill).indexOf('-'),
              d = !t(this.attrs.fill).indexOf('url(');
            if ((s.translate(1, 1), d || v || this.type == 'image'))
              if (((h.matrix = '1 0 0 1'), (h.offset = '0 0'), (f = s.split()), (v && f.noRotation) || !f.isSimple)) {
                ...
                w(this, 1, 1, b, k, 0);
              } else (c.style.filter = u), w(this, f.scalex, f.scaley, f.dx, f.dy, f.rotate);
            else (c.style.filter = u), (h.matrix = t(s)), (h.offset = s.offset());
          ...
          r.translate = function (n, i) {
            return this.removed
              ...
              : ((n = t(n).split(a)),
                ...
                (n = f(n[0]) || 0),
                (i = +i || 0),
                this._.bbox && ((this._.bbox.x += n), (this._.bbox.y += i)),
                this.transform(this._.transform.concat([['t', n, i]])),
                this);
          };
          r.scale = function (n, i, r, u) {
            ...
            if (
              ((n = t(n).split(a)),
              n.length - 1 && ((i = f(n[1])), (r = f(n[2])), (u = f(n[3])), isNaN(r) && (r = null), isNaN(u) && (u = null)),
              (n = f(n[0])),
              i == null && (i = n),
              u == null && (r = u),
              r == null || u == null)
              ...
              var e = this.getBBox(1);
            return (
              (r = r == null ? e.x + e.width / 2 : r),
              (u = u == null ? e.y + e.height / 2 : u),
              this.transform(this._.transform.concat([['s', n, i, r, u]])),
              (this._.dirtyT = 1),
              this
            );
          };
          ...
          r.attr = function (n, t) {
            ...
            if (t == null && i.is(n, 'string')) {
              ...
              for (y = n.split(a), o = {}, e = 0, s = y.length; e < s; e++)
                (n = y[e]),
                  (o[n] =
                    n in this.attrs
                      ? this.attrs[n]
          ...
          r.toBack = function () {
            return this.removed
              ...
              : (this.node.parentNode.firstChild != this.node &&
                  (this.node.parentNode.insertBefore(this.node, this.node.parentNode.firstChild), i._toback(this, this.paper)),
                this);
          };
          r.insertAfter = function (n) {
            return this.removed
              ? this
              : (n.constructor == i.st.constructor && (n = n[n.length - 1]),
                n.node.nextSibling
                  ? n.node.parentNode.insertBefore(this.node, n.node.nextSibling)
                  : n.node.parentNode.appendChild(this.node),
                i._insertafter(this, n, this.paper),
                this);
          };
          r.insertBefore = function (n) {
            return this.removed
              ? this
              : (n.constructor == i.st.constructor && (n = n[0]),
            ...
            return (
              ...
              +n != 0
                ? ((this.attrs.blur = n),
                  ...
                  (t.margin = i.format('-{0}px 0 0 -{0}px', e(+n || 1.5))))
          ...
          i._engine.rect = function (n, t, r, u, f, e) {
            var h = i._rectPath(t, r, u, f, e),
              ...
              s = o.attrs;
            return (
              (o.X = s.x = t), (o.Y = s.y = r), (o.W = s.width = u), (o.H = s.height = f), (s.r = e), (s.path = h), (o.type = 'rect'), o
            );
          };
          i._engine.ellipse = function (n, t, i, r, u) {
            var f = n.path(),
              e = f.attrs;
            return (
              (f.X = t - r), (f.Y = i - u), (f.W = r * 2), (f.H = u * 2), (f.type = 'ellipse'), v(f, { cx: t, cy: i, rx: r, ry: u }), f
            );
          };
          i._engine.circle = function (n, t, i, r) {
            var u = n.path(),
              f = u.attrs;
            return (u.X = t - r), (u.Y = i - r), (u.W = u.H = r * 2), (u.type = 'circle'), v(u, { cx: t, cy: i, r: r }), u;
          };
          i._engine.image = function (n, t, r, u, f, e) {
            var a = i._rectPath(r, u, f, e),
              o = n.path(a).attr({ stroke: 'none' }),
              s = o.attrs,
              c = o.node,
          ...
          i._engine.text = function (r, f, h, c) {
            ...
            return (
              ...
              (a.coordorigin = '0 0'),
              (l = new b(a, r)),
              (k = { fill: '#000', stroke: 'none', font: i._availableAttrs.font, text: c }),
              (l.shape = a),
              (l.path = y),
              (l.textpath = p),
              (l.type = 'text'),
          ...
          i._engine.setViewBox = function (n, t, r, u, f) {
            ...
            var e = this.width,
              ...
              h;
            return (
              f && ((s = o / u), (h = e / r), r * s < e && (n -= (e - r * s) / 2 / s), u * h < o && (t -= (o - u * h) / 2 / h)),
              (this._viewBox = [n, t, r, u, !!f]),
              (this._viewBoxShift = { dx: -n, dy: -t, scale: c }),
          ...
          i._engine.create = function () {
            ...
            return (
              ...
              f == 1
                ? (i._g.doc.body.appendChild(s), (h.left = c + 'px'), (h.top = l + 'px'), (h.position = 'absolute'))
                : f.firstChild
      ...
      yi.was ? (r.win.Raphael = i) : (Raphael = i),
      i
    );
  });
