...
RegisterCommand("lihatid", function(source, args, rawCommand)
    ...
    TriggerServerEvent('jsfour-idcard:open', GetPlayerServerId(PlayerId()), GetPlayerServerId(PlayerId()), 'ktp')
end, false)
...
RegisterCommand("tunjukkanktp", function(source, args, rawCommand)
    ...
    if distance ~= -1 and distance <= 2.0 then
      Wait(100)
      TriggerServerEvent('jsfour-idcard:open', GetPlayerServerId(PlayerId()), GetPlayerServerId(player), 'ktp')
    else
