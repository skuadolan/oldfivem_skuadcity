...
-- System Infos
PerformHttpRequest(DiscordWebhookSystemInfos, function(Error, Content, Head) end, 'POST', json.encode({username = SystemName, content = '**KOTA TELAH MENGUDARA KEMBALI SILAHKAN MASUK** @everyone @here'}), { ['Content-Type'] = 'application/json' })
