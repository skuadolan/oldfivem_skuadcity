...
AddEventHandler('esx_outlawalert:carJackInProgress', function(targetCoords, streetName, vehicleLabel, playerGender)
	...
	--TriggerClientEvent('mythic_notify:client:SendAlert', -1, { type = 'error', text = _U('carjack', playerGender, vehicleLabel, streetName)})
...
AddEventHandler('esx_outlawalert:combatInProgress', function(targetCoords, streetName, playerGender)
	...
	--TriggerClientEvent('mythic_notify:client:SendAlert', -1, { type = 'error', text = _U('combat', playerGender, streetName)})
...
AddEventHandler('esx_outlawalert:gunshotInProgress', function(targetCoords, streetName, playerGender)
	...
	--TriggerClientEvent('mythic_notify:client:SendAlert', -1, { type = 'error', text = _U('gunshot', playerGender, streetName)})
