	...
	if xPlayer["job"]["name"] == "police" then
		...
		if GetPlayerName(jailPlayer) ~= nil then
			...
			if jailTime ~= nil then
				...
				TriggerClientEvent('skd_cSide:forServerNotify', -1, 'inform', GetPlayerName(jailPlayer) .. " Dipenjara selama " .. jailTime .. " menit!")
				...
				TriggerClientEvent('skd_cSide:forServerNotify', -1, 'error', _U('Waktu tidak tepat'))
				--TriggerClientEvent("esx:showNotification", src, "This time is invalid!")
			end
		else
			TriggerClientEvent('skd_cSide:forServerNotify', -1, 'error', _U('Warga tidak dikota'))
			--TriggerClientEvent("esx:showNotification", src, "This ID is not online!")
		end
	else
		TriggerClientEvent('skd_cSide:forServerNotify', -1, 'error', _U('Kamu bukan sipir'))
...
AddEventHandler("esx-qalle-jail:jailPlayer", function(targetSrc, jailTime, jailReason)
	...
	TriggerClientEvent('skd_cSide:forServerNotify', -1, 'inform', GetPlayerName(targetSrc) .. "Dipenjara selama " .. jailTime .. " menit!")
...
AddEventHandler("esx-qalle-jail:unJailPlayer", function(targetIdentifier)
	...
	TriggerClientEvent('skd_cSide:forServerNotify', -1, 'error', xPlayer.name .. " Bebas dari penjara!")
...
AddEventHandler("esx-qalle-jail:prisonWorkReward", function()
	...
	TriggerClientEvent('skd_cSide:forServerNotify', -1, 'error', _U('Terima uang'))
