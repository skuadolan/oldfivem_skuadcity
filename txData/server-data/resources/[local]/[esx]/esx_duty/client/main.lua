      ...
      if IsControlPressed(0, Keys['E']) then
        if CurrentAction == 'ambulance_duty' then
          ...
          if PlayerData.job.name == 'ambulance' then
            exports['mythic_notify']:DoHudText('inform', 'Anda Off-Duty.')
            Wait(1000)
          else
            exports['mythic_notify']:DoHudText('inform', 'Anda On-Duty.')
            Wait(1000)
          end
        else
          exports['mythic_notify']:DoHudText('inform', 'Anda bukan EMS.')
          Wait(1000)
        end
      end
        ...
        if CurrentAction == 'mechanic_duty' then
          ...
          exports['mythic_notify']:DoHudText('inform', 'Anda bukan Mechanic.')
          Wait(1000)
        end
      end
        ...
        if CurrentAction == 'police_duty' then
          ...
          exports['mythic_notify']:DoHudText('inform', 'Anda bukan Polisi.')
          Wait(1000)
          end
        end
      end
