...
var render = function () {
  ...
  ctx.font = "17px 'Titan One', cursive";
  ctx.textAlign = "right";
  ctx.textBaseline = "top";
 // ctx.fillText(game_state.win, 265, 358);
  ctx.fillText("Menang Rp. " + game_state.paid, 385, 367);

  ctx.fillText("Taruhan Rp. " +playerbet, 595, 367);
  ...
  // draw game state highlight tiles
	...
	ctx.textAlign = "right";
	ctx.textBaseline = "top";
	  ctx.fillText("Spin Gratis " +freespins, 395, 367);
  ctx.fillText("Menang Rp. " + game_state.paid, 625, 367);
  }
