...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        for k, v in pairs(Config.Shops.Mech.Locations) do
            if GetDistanceBetweenCoords(coords, Config.Shops.Mech.Locations[k].x, Config.Shops.Mech.Locations[k].y, Config.Shops.Mech.Locations[k].z, true) < 3.0 then
            sleep = false
            end
        end
        ...
        for k, v in pairs(Config.Shops.Pedagang.Locations) do
            if GetDistanceBetweenCoords(coords, Config.Shops.Pedagang.Locations[k].x, Config.Shops.Pedagang.Locations[k].y, Config.Shops.Pedagang.Locations[k].z, true) < 6.0 then
            sleep = false
            end
        end

        for k, v in pairs(Config.Shops.Police.Locations) do
            if GetDistanceBetweenCoords(coords, Config.Shops.Police.Locations[k].x, Config.Shops.Police.Locations[k].y, Config.Shops.Police.Locations[k].z, true) < 6.0 then
            sleep = false
            end
        end

        for k, v in pairs(Config.Shops.Ambulance.Locations) do
            if GetDistanceBetweenCoords(coords, Config.Shops.Ambulance.Locations[k].x, Config.Shops.Ambulance.Locations[k].y, Config.Shops.Ambulance.Locations[k].z, true) < 3.0 then
            sleep = false
            end
        end
