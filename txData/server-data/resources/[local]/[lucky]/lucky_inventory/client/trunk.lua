...
RegisterNetEvent("lucky_inventory:openTrunkInventory")
AddEventHandler(
    "lucky_inventory:openTrunkInventory",
...
RegisterNetEvent("lucky_inventory:refreshTrunkInventory")
AddEventHandler(
    "lucky_inventory:refreshTrunkInventory",
    function(data, blackMoney, inventory, weapons)
        setTrunkInventoryData(data, blackMoney, inventory, weapons)
    end
)
