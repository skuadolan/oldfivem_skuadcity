...
Citizen.CreateThread(function()
  TriggerEvent('chat:addSuggestion', '/twt', 'Send a tweet')
end)
Citizen.CreateThread(function()
  TriggerEvent('chat:addSuggestion', '/vpn', 'Illegal Conversations')
end)
Citizen.CreateThread(function()
  TriggerEvent('chat:addSuggestion', '/ooc', 'Out of character chat')
end)
Citizen.CreateThread(function()
  TriggerEvent('chat:addSuggestion', '/adv', 'Local Ad')
end)
...
function Initialize(scaleform)
	...
	PushScaleformMovieFunctionParameterString("~b~Announcement")
