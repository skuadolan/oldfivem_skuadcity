RegisterNetEvent('skd_pausemenu:SendReport')
AddEventHandler('skd_pausemenu:SendReport', function(data)
...
RegisterServerEvent('skd_pausemenu:DropPlayer')
AddEventHandler('skd_pausemenu:DropPlayer', function()
