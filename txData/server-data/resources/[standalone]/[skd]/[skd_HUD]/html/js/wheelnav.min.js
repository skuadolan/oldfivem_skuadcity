...
wheelnav = function (n, t, i, r) {
  ...
  if (
    ((this.holderId = 'wheel'),
    n !== undefined && n !== null && (this.holderId = n),
    (u = document.getElementById(n)),
    (u === null || u === undefined) && (t === undefined || t === null))
  )
    return this;
  if (((s = !0), t === undefined || t === null)) {
    ...
    i !== undefined && i !== null
      ? ((r === undefined || r === null) && (r = i), (this.raphael = new Raphael(n, i, r)), (e = i))
      : ((this.raphael = new Raphael(n)), (e = u.clientWidth));
    this.raphael.setViewBox(0, 0, this.raphael.width, this.raphael.height, !0);
  } else (this.raphael = t), (e = this.raphael.width), (s = !1);
  return (
    (this.centerX = e / 2),
    (this.centerY = e / 2),
    (this.wheelRadius = e / 2),
    (this.navAngle = 0),
    (this.sliceAngle = null),
    (this.titleRotateAngle = null),
    (this.initTitleRotate = !1),
    (this.clickModeRotate = !0),
    (this.rotateRound = !1),
    (this.rotateRoundCount = 0),
    (this.clickModeSpreadOff = !1),
    (this.animatetimeCalculated = !1),
    ...
    (this.cssMode = !1),
    (this.selectedToFront = !0),
    (this.selectedNavItemIndex = 0),
    (this.navItemCount = 0),
    (this.navItemCountLabeled = !1),
    (this.navItemCountLabelOffset = 0),
    (this.navItems = []),
    (this.navItemsEnabled = !0),
    (this.animateFinishFunction = null),
    (this.navItemsContinuous = !1),
    (this.navItemsCentered = !0),
    (this.colors = colorpalette.defaultpalette),
    (this.titleSpreadScale = null),
    (this.spreaderEnable = !1),
    ...
    (this.slicePathFunction = slicePath().PieSlice !== undefined ? slicePath().PieSlice : slicePath().NullSlice),
    ...
    (this.keynavigateEnabled = !1),
    (this.keynavigateOnlyFocus = !1),
...
wheelnav.prototype.initWheel = function (n) {
  ...
  for (
    this.styleWheel(),
      this.navItemCount === 0
        ? ((n !== undefined && n !== null && Array.isArray(n)) || (n = ['title-0', 'title-1', 'title-2', 'title-3']),
          (this.navItemCount = n.length))
        : (n = null),
      i = 0;
    i < this.navItemCount;
    i++
    ...
    (r = ''),
      (r = this.navItemCountLabeled ? (i + this.navItemCountLabelOffset).toString() : n !== null ? n[i] : ''),
      (u = new wheelnavItem(this, r, i)),
      this.navItems.push(u);
...
wheelnav.prototype.createWheel = function (n, t) {
  for (
    this.currentPercent === null && (this.currentPercent = t ? this.minPercent : this.maxPercent),
      this.navItems.length === 0 && this.initWheel(n),
      this.selectedNavItemIndex !== null && (this.navItems[this.selectedNavItemIndex].selected = !0),
      i = 0;
    i < this.navItemCount;
    i++
  )
  ...
  if (this.keynavigateEnabled) {
    var r = this,
      u = window;
    this.keynavigateOnlyFocus &&
      ((u = document.getElementById(this.holderId)), u.hasAttribute('tabindex') || u.setAttribute('tabindex', 0));
    u.addEventListener(
      'keydown',
      (this.keyNavigateFunction = function (n) {
        var t, i;
        n = n || window.e;
        t = n.which || n.keyCode;
        [r.keynavigateDownCode, r.keynavigateDownCodeAlt, r.keynavigateUpCode, r.keynavigateUpCodeAlt].indexOf(n.keyCode) > -1 &&
          n.preventDefault();
        i = null;
        (t === r.keynavigateUpCode || t === r.keynavigateUpCodeAlt) && (i = r.currentClick === r.navItemCount - 1 ? 0 : r.currentClick + 1);
        (t === r.keynavigateDownCode || t === r.keynavigateDownCodeAlt) &&
          (i = r.currentClick === 0 ? r.navItemCount - 1 : r.currentClick - 1);
        i !== null && r.navigateWheel(i);
      })
    );
  }
  return (
    (this.spreader = new spreader(this)), (this.marker = new marker(this)), this.refreshWheel(), t !== undefined && this.spreadWheel(), this
  );
};
wheelnav.prototype.removeWheel = function () {
  if ((this.raphael.remove(), this.keynavigateEnabled)) {
    var n = window;
    this.keynavigateOnlyFocus &&
      ((n = document.getElementById(this.holderId)), n.hasAttribute('tabindex') && n.removeAttribute('tabindex'));
    n.removeEventListener('keydown', this.keyNavigateFunction);
  }
};
...
wheelnav.prototype.navigateWheel = function (n) {
  var t, r, u;
  for (this.animateUnlock(!0), this.clickModeRotate && (this.animateLocked = !0), i = 0; i < this.navItemCount; i++)
    (t = this.navItems[i]),
      (t.hovered = !1),
      i === n
        ? this.multiSelect
          ? (t.selected = !t.selected)
          : ((t.selected = !0), (this.selectedNavItemIndex = i))
        : this.multiSelect || (t.selected = !1),
      this.clickModeRotate &&
        ((r = this.navItems[n].navAngle - this.navItems[this.currentClick].navAngle),
        this.rotateRound && (this.clockwise && r < 0 && (r = 360 + r), !this.clockwise && r > 0 && (r = r - 360)),
        (t.currentRotateAngle -= r),
        (u = this.animatetime != null ? this.animatetime : 1500),
        this.animatetimeCalculated && n !== this.currentClick && (t.animatetime = u * (Math.abs(r) / 360)),
        this.rotateRoundCount > 0 &&
          (this.clockwise ? (t.currentRotateAngle -= this.rotateRoundCount * 360) : (t.currentRotateAngle += this.rotateRoundCount * 360),
          (t.animatetime = u * (this.rotateRoundCount + 1))));
  for (i = 0; i < this.navItemCount; i++) (t = this.navItems[i]), t.setCurrentTransform(!0, !0), t.refreshNavItem();
  this.currentClick = n;
  this.clickModeSpreadOff
    ? ((this.currentPercent = this.maxPercent), this.spreadWheel())
    : (n === null || this.clickModeRotate
        ? this.marker.setCurrentTransform()
        : this.marker.setCurrentTransform(this.navItems[this.currentClick].navAngle),
      this.spreader.setCurrentTransform(!0));
  n !== null && this.navItems[n].navigateFunction !== null && this.navItems[n].navigateFunction();
};
wheelnav.prototype.spreadWheel = function () {
  for (
    this.animateUnlock(!0),
      this.animateLocked = !0,
...
wheelnav.prototype.animateUnlock = function (n, t) {
  ...
  if (n !== undefined && n === !0)
    for (i = 0; i < this.navItemCount; i++)
      (this.navItems[i].navSliceUnderAnimation = !1),
        (this.navItems[i].navTitleUnderAnimation = !1),
        (this.navItems[i].navLineUnderAnimation = !1),
        this.navItems[i].navSlice.stop(),
        this.navItems[i].navLine.stop(),
        this.navItems[i].navTitle.stop();
  else {
    for (r = 0; r < this.navItemCount; r++)
      if (
        this.navItems[r].navSliceUnderAnimation === !0 ||
        this.navItems[r].navTitleUnderAnimation === !0 ||
        this.navItems[r].navLineUnderAnimation === !0
      )
        return;
    this.animateLocked = !1;
...
wheelnav.prototype.parseWheel = function (n) {
  var it, l, a, v, ut, ft, et, y, e, ot, o, p, w, st, ht, b, k, d, g, ct, lt, u, s, t;
  if (n !== undefined && n !== null) {
    if (((it = n.hasAttribute('data-wheelnav')), it)) {
      var i = [],
        h = [],
        f = [],
        rt = !1,
      ...
      for (
        c !== null && slicePath()[c] !== undefined && (this.slicePathFunction = slicePath()[c]),
          l = n.getAttribute('data-wheelnav-colors'),
          l !== null && (this.colors = l.split(',')),
          a = n.getAttribute('data-wheelnav-wheelradius'),
          a !== null && (this.wheelRadius = Number(a)),
          v = n.getAttribute('data-wheelnav-navangle'),
          v !== null && (this.navAngle = Number(v)),
          ut = n.getAttribute('data-wheelnav-rotateoff'),
          ut !== null && (this.clickModeRotate = !1),
          ft = n.getAttribute('data-wheelnav-cssmode'),
          ft !== null && (this.cssMode = !0),
          et = n.getAttribute('data-wheelnav-spreader'),
          et !== null && (this.spreaderEnable = !0),
          y = n.getAttribute('data-wheelnav-spreaderradius'),
          y !== null && (this.spreaderRadius = Number(y)),
          e = n.getAttribute('data-wheelnav-spreaderpath'),
          e !== null && markerPath()[e] !== undefined && (this.spreaderPathFunction = spreaderPath()[e]),
          ot = n.getAttribute('data-wheelnav-marker'),
          ot !== null && (this.markerEnable = !0),
          o = n.getAttribute('data-wheelnav-markerpath'),
          o !== null && markerPath()[o] !== undefined && (this.markerPathFunction = markerPath()[o]),
          p = n.getAttribute('data-wheelnav-titlewidth'),
          p !== null && (this.titleWidth = Number(p)),
          w = n.getAttribute('data-wheelnav-titleheight'),
          w !== null && (this.titleHeight = Number(w)),
          st = n.getAttribute('data-wheelnav-keynav'),
          st !== null && (this.keynavigateEnabled = !0),
          ht = n.getAttribute('data-wheelnav-keynavonlyfocus'),
          ht !== null && (this.keynavigateOnlyFocus = !0),
          b = n.getAttribute('data-wheelnav-keynavdowncode'),
          b !== null && (this.keynavigateDownCode = Number(b)),
          k = n.getAttribute('data-wheelnav-keynavdowncodealt'),
          k !== null && (this.keynavigateDownCodeAlt = Number(k)),
          d = n.getAttribute('data-wheelnav-keynavupcode'),
          d !== null && (this.keynavigateUpCode = Number(d)),
          g = n.getAttribute('data-wheelnav-keynavupcodealt'),
          g !== null && (this.keynavigateUpCodeAlt = Number(g)),
          ct = n.getAttribute('data-wheelnav-init'),
          ct !== null && (rt = !0),
          t = 0;
        t < n.children.length;
        t++
      ) {
        var nt = n.children[t].getAttribute('data-wheelnav-navitemtext'),
          r = n.children[t].getAttribute('data-wheelnav-navitemicon'),
          tt = n.children[t].getAttribute('data-wheelnav-navitemimg');
        if (nt !== null || r !== null || tt !== null) {
          if (nt !== null) i.push(nt);
          else if (r !== null) icon[r] !== undefined ? i.push(icon[r]) : i.push(r);
          else if (tt !== null) i.push('imgsrc:' + tt);
          else continue;
          for (
            n.children[t].onmouseup !== undefined ? f.push(n.children[t].onmouseup) : f.push(null), lt = !1, u = 0;
            u < n.children[t].children.length;
            u++
          )
            n.children[t].children[u].getAttribute('href') !== undefined && h.push(n.children[t].children[u].getAttribute('href'));
          lt || h.push(null);
        }
      }
      if (i.length > 0) {
        for (this.initWheel(i), t = 0; t < f.length; t++)
          (this.navItems[t].navigateFunction = f[t]), (this.navItems[t].navigateHref = h[t]);
        rt || this.createWheel();
      }
    }
...
wheelnavItem = function (n, t, i) {
  return (
    (this.wheelnav = n),
    (this.wheelItemIndex = i),
    (this.itemIndex = n.clockwise ? i : -i),
    (this.enabled = n.navItemsEnabled),
    (this.selected = !1),
    (this.hovered = !1),
    (this.navItem = null),
    (this.navSlice = null),
    ...
    (this.navSliceUnderAnimation = !1),
    (this.navTitleUnderAnimation = !1),
    (this.navLineUnderAnimation = !1),
...
wheelnavItem.prototype.createNavItem = function () {
  ...
  this.wheelnav.cssMode ||
    ((this.slicePathAttr.fill = this.fillAttr), (this.sliceHoverAttr.fill = this.fillAttr), (this.sliceSelectedAttr.fill = this.fillAttr));
  this.enabled ||
    (this.wheelnav.cssMode ||
  ...
  i = this.wheelItemIndex - 1;
  n = 360 / this.wheelnav.navItemCount;
  this.sliceAngle === null && (this.sliceAngle = 360 / this.wheelnav.navItemCount);
  this.wheelnav.clockwise
    ? this.wheelnav.navItemsContinuous
      ? (this.baseAngle =
          this.itemIndex === 0
            ? this.itemIndex * this.sliceAngle + (-this.sliceAngle / 2 + this.wheelnav.navAngle)
            : this.wheelnav.navItems[i].baseAngle + this.wheelnav.navItems[i].sliceAngle)
      : this.wheelnav.navItemsCentered
      ? (this.baseAngle = this.itemIndex * n + (-this.sliceAngle / 2 + this.wheelnav.navAngle))
      : ((this.baseAngle = this.itemIndex * n + (-n / 2 + this.wheelnav.navAngle)),
        (this.currentRotateAngle += n / 2 - this.wheelnav.navItems[0].sliceAngle / 2))
    : this.wheelnav.navItemsContinuous
    ? (this.baseAngle =
        this.itemIndex === 0
          ? this.itemIndex * this.sliceAngle + (-this.sliceAngle / 2 + this.wheelnav.navAngle)
          : this.wheelnav.navItems[i].baseAngle - this.wheelnav.navItems[this.wheelItemIndex].sliceAngle)
    : this.wheelnav.navItemsCentered
    ? (this.baseAngle = this.itemIndex * n + (-this.sliceAngle / 2 + this.wheelnav.navAngle))
    : ((this.baseAngle = this.itemIndex * n + (-n / 2 + this.wheelnav.navAngle) + (n - this.sliceAngle)),
      (this.currentRotateAngle -= n / 2 - this.wheelnav.navItems[0].sliceAngle / 2));
  ...
  r = this.initNavTitle;
  this.navTitle = wheelnavTitle().isPathTitle(this.title)
    ? this.wheelnav.raphael.path(r.path)
    : wheelnavTitle().isImageTitle(this.title)
    ? this.wheelnav.raphael.image(
        r.src,
        t.titlePosX - this.titleWidth / 2,
        t.titlePosY - this.titleHeight / 2,
        this.titleWidth,
        this.titleHeight
      )
    : this.wheelnav.raphael.text(t.titlePosX, t.titlePosY, r.title);
  ...
  this.wheelnav.currentPercent < 0.05 && (this.navTitleCurrentTransformString += ',s0.05');
  ...
  this.sliceClickablePathFunction !== null
    ? ((e = this.getCurrentClickablePath()),
      (this.navClickableSlice = this.wheelnav.raphael.path(e.slicePathString).attr(this.sliceClickablePathAttr).toBack()),
...
wheelnavItem.prototype.hoverEffect = function (n, t) {
  this.wheelnav.animateLocked === !1 &&
    (t && (this.selected || (this.hovered = !0)),
    this.refreshNavItem(),
    (this.hoverPercent !== 1 ||
      this.sliceHoverPathFunction !== null ||
      this.sliceHoverTransformFunction !== null ||
...
wheelnavItem.prototype.setCurrentTransform = function (n, t) {
  ...
  if (!this.wheelnav.clickModeRotate || (!this.navSliceUnderAnimation && !this.navTitleUnderAnimation && !this.navLineUnderAnimation))
    if (
      (n !== undefined &&
        n === !0 &&
        ((this.navSliceUnderAnimation = !0), (this.navTitleUnderAnimation = !0), (this.navLineUnderAnimation = !0)),
      (this.navSliceCurrentTransformString = ''),
      this.wheelnav.clickModeRotate && (this.navSliceCurrentTransformString += this.getItemRotateString()),
      this.selected
        ? this.selectTransform.sliceTransformString !== undefined &&
          (this.navSliceCurrentTransformString += this.selectTransform.sliceTransformString)
        : this.hovered &&
          this.hoverTransform.sliceTransformString !== undefined &&
          (this.navSliceCurrentTransformString += this.hoverTransform.sliceTransformString),
      this.sliceTransform.sliceTransformString !== undefined &&
        (this.navSliceCurrentTransformString += this.sliceTransform.sliceTransformString),
      (this.navLineCurrentTransformString = ''),
      this.wheelnav.clickModeRotate && (this.navLineCurrentTransformString += this.getItemRotateString()),
      this.selected
        ? this.selectTransform.lineTransformString !== undefined &&
          (this.navLineCurrentTransformString += this.selectTransform.lineTransformString)
        : this.hovered &&
          this.hoverTransform.lineTransformString !== undefined &&
          (this.navLineCurrentTransformString += this.hoverTransform.lineTransformString),
      this.sliceTransform.lineTransformString !== undefined &&
        (this.navLineCurrentTransformString += this.sliceTransform.lineTransformString),
      (this.navTitleCurrentTransformString = ''),
      (this.navTitleCurrentTransformString += this.getTitleRotateString(!0)),
      this.selected
        ? (this.navTitleSizeSelectedTransform !== undefined && (this.navTitleCurrentTransformString += this.navTitleSizeSelectedTransform),
          (this.navTitleCurrentTransformString +=
            this.selectTransform.titleTransformString === '' || this.selectTransform.titleTransformString === undefined
              ? ',s1'
              : ',' + this.selectTransform.titleTransformString),
          this.wheelnav.currentPercent < 0.05 && (this.navTitleCurrentTransformString += ',s0.05'))
        : this.hovered
        ? (this.navTitleSizeHoverTransform !== undefined && (this.navTitleCurrentTransformString += this.navTitleSizeHoverTransform),
          (this.navTitleCurrentTransformString +=
            this.hoverTransform.titleTransformString === '' || this.hoverTransform.titleTransformString === undefined
              ? ',s1'
              : ',' + this.hoverTransform.titleTransformString))
        : this.wheelnav.currentPercent < 0.05
        ? (this.navTitleCurrentTransformString += ',s0.05')
        : this.titleSpreadScale
        ? (this.navTitleCurrentTransformString += ',s' + this.wheelnav.currentPercent)
        : (this.navTitleSizeTransform !== undefined && (this.navTitleCurrentTransformString += this.navTitleSizeTransform),
          (this.navTitleCurrentTransformString +=
            this.sliceTransform.titleTransformString === '' || this.sliceTransform.titleTransformString === undefined
              ? ',s1'
              : ',' + this.sliceTransform.titleTransformString)),
      (h = this.getCurrentPath()),
      (c = {}),
      (c = { path: h.slicePathString, transform: this.navSliceCurrentTransformString }),
      (l = {}),
      this.sliceClickablePathFunction !== null &&
        ((w = this.getCurrentClickablePath()), (l = { path: w.slicePathString, transform: this.navSliceCurrentTransformString })),
      (a = {}),
      (a = { path: h.linePathString, transform: this.navLineCurrentTransformString }),
      (r = this.getCurrentTitle()),
      (f = {}),
      wheelnavTitle().isPathTitle(r.title)
        ? (f = { path: r.path, transform: this.navTitleCurrentTransformString })
        : wheelnavTitle().isImageTitle(r.title)
        ? ((f = { x: r.x, y: r.y, width: r.width, height: r.height, transform: this.navTitleCurrentTransformString }),
          this.navTitle.attr({ src: r.src }))
        : ((f = { x: r.x, y: r.y, transform: this.navTitleCurrentTransformString }),
          r.title !== null && this.navTitle.attr({ text: r.title })),
      (e = this),
      (o = this.wheelnav),
      (this.animSlice = Raphael.animation(c, this.animatetime, this.animateeffect, function () {
      ...
      this.navClickableSlice !== null && (this.animClickableSlice = Raphael.animation(l, this.animatetime, this.animateeffect)),
      (u = this.wheelnav.animateRepeatCount),
      n !== undefined && n === !0)
    ) {
      if (this.wheelItemIndex === this.wheelnav.navItemCount - 1) {
        ...
        if (this.wheelnav.sliceClickablePathFunction !== null)
          for (i = 0; i < this.wheelnav.navItemCount; i++)
            (s = this.wheelnav.navItems[i]), s.navClickableSlice !== null && s.navClickableSlice.animate(s.animClickableSlice.repeat(u));
      }
    } else
      this.navSlice.animate(this.animSlice.repeat(u)),
        this.navLine.animate(this.animLine.repeat(u)),
        this.navTitle.animate(this.animTitle.repeat(u)),
        this.navClickableSlice !== null && this.navClickableSlice.animate(this.animClickableSlice.repeat(u));
};
wheelnavItem.prototype.setTitle = function (n) {
  this.title = n === undefined ? null : n;
  this.titleHover = this.title;
  this.titleSelected = this.title;
};
wheelnavItem.prototype.setTooltip = function (n) {
  n !== null && this.navItem.attr({ title: n });
};
wheelnavItem.prototype.refreshNavItem = function (n) {
  this.selected
    ? (this.navSlice.attr(this.sliceSelectedAttr),
      ...
      this.navClickableSlice !== null && this.navClickableSlice.attr(this.sliceClickableSelectedAttr),
      this.wheelnav.selectedToFront
        ? (this.navSlice.toFront(),
          this.navLine.toFront(),
          this.navTitle.toFront(),
          this.navClickableSlice !== null && this.navClickableSlice.toFront())
        : (this.navClickableSlice !== null && this.navClickableSlice.toBack(),
    ...
    ? (this.navSlice.attr(this.sliceHoverAttr).toFront(),
      ...
      this.navClickableSlice !== null && this.navClickableSlice.attr(this.sliceClickableHoverAttr).toFront())
    : (this.navSlice.attr(this.slicePathAttr),
      this.navLine.attr(this.linePathAttr),
      this.navTitle.attr(this.titleAttr),
      this.navClickableSlice !== null && this.navClickableSlice.attr(this.sliceClickablePathAttr),
      this.navClickableSlice !== null && this.navClickableSlice.toBack(),
      this.navTitle.toBack(),
      this.navLine.toBack(),
      this.navSlice.toBack());
...
wheelnavItem.prototype.setWheelSettings = function (n) {
  ...
  this.wheelnav.titleRotateAngle !== null && this.titleRotateAngle === null && (this.titleRotateAngle = this.wheelnav.titleRotateAngle);
  ...
  wheelnavTitle().isImageTitle(this.title) &&
    (this.titleWidth === null && (this.titleWidth = 32), this.titleHeight === null && (this.titleHeight = 32));
  ...
  this.wheelnav.titleSelectedWidth !== null &&
    this.titleSelectedWidth === null &&
    (this.titleSelectedWidth = this.wheelnav.titleSelectedWidth);
  this.wheelnav.titleSelectedHeight !== null &&
    this.titleSelectedHeight === null &&
  ...
  this.title !== null
    ? ((this.sliceInitPathFunction === null || n) && (this.sliceInitPathFunction = this.wheelnav.sliceInitPathFunction),
      (this.sliceClickablePathFunction === null || n) && (this.sliceClickablePathFunction = this.wheelnav.sliceClickablePathFunction),
      (this.slicePathFunction === null || n) && (this.slicePathFunction = this.wheelnav.slicePathFunction),
      (this.sliceSelectedPathFunction === null || n) && (this.sliceSelectedPathFunction = this.wheelnav.sliceSelectedPathFunction),
      (this.sliceHoverPathFunction === null || n) && (this.sliceHoverPathFunction = this.wheelnav.sliceHoverPathFunction),
      (this.sliceTransformFunction === null || n) && (this.sliceTransformFunction = this.wheelnav.sliceTransformFunction),
      (this.sliceSelectedTransformFunction === null || n) &&
        (this.sliceSelectedTransformFunction = this.wheelnav.sliceSelectedTransformFunction),
      (this.sliceHoverTransformFunction === null || n) && (this.sliceHoverTransformFunction = this.wheelnav.sliceHoverTransformFunction),
      (this.sliceInitTransformFunction === null || n) && (this.sliceInitTransformFunction = this.wheelnav.sliceInitTransformFunction))
  ...
  (this.titleSpreadScale === null || n) &&
    (this.titleSpreadScale = this.wheelnav.titleSpreadScale !== null ? this.wheelnav.titleSpreadScale : !1);
...
wheelnavItem.prototype.initPathsAndTransforms = function () {
  ...
  this.selectedSlicePathMin =
    this.sliceSelectedPathFunction !== null
      ? this.sliceSelectedPathFunction(this.sliceHelper, this.selectedPercent * this.minPercent, this.sliceSelectedPathCustom)
      : this.slicePathFunction(this.sliceHelper, this.selectedPercent * this.minPercent, this.sliceSelectedPathCustom);
  this.selectedSlicePathMax =
    this.sliceSelectedPathFunction !== null
      ? this.sliceSelectedPathFunction(this.sliceHelper, this.selectedPercent * this.maxPercent, this.sliceSelectedPathCustom)
      : this.slicePathFunction(this.sliceHelper, this.selectedPercent * this.maxPercent, this.sliceSelectedPathCustom);
  this.hoverSlicePathMin =
    this.sliceHoverPathFunction !== null
      ? this.sliceHoverPathFunction(this.sliceHelper, this.hoverPercent * this.minPercent, this.sliceHoverPathCustom)
      : this.slicePathFunction(this.sliceHelper, this.hoverPercent * this.minPercent, this.sliceHoverPathCustom);
  this.hoverSlicePathMax =
    this.sliceHoverPathFunction !== null
      ? this.sliceHoverPathFunction(this.sliceHelper, this.hoverPercent * this.maxPercent, this.sliceHoverPathCustom)
      : this.slicePathFunction(this.sliceHelper, this.hoverPercent * this.maxPercent, this.sliceHoverPathCustom);
  this.sliceClickablePathFunction !== null &&
    ((this.clickableSlicePathMin = this.sliceClickablePathFunction(
      this.sliceHelper,
      this.clickablePercentMin,
      this.sliceClickablePathCustom
    )),
    (this.clickableSlicePathMax = this.sliceClickablePathFunction(
      this.sliceHelper,
      this.clickablePercentMax,
      this.sliceClickablePathCustom
    )));
  this.sliceInitPath =
    this.sliceInitPathFunction !== null
      ? this.sliceInitPathFunction(this.sliceHelper, this.initPercent, this.sliceInitPathCustom)
      : this.wheelnav.currentPercent === this.wheelnav.maxPercent
      ? this.slicePathFunction(this.sliceHelper, this.maxPercent, this.sliceInitPathCustom)
      : this.slicePathFunction(this.sliceHelper, this.minPercent, this.sliceInitPathCustom);
  this.sliceTransform =
    this.sliceTransformFunction !== null
      ? this.sliceTransformFunction(
          this.wheelnav.centerX,
          this.wheelnav.centerY,
          this.wheelnav.wheelRadius,
          this.baseAngle,
          this.sliceAngle,
          this.titleRotateAngle,
          this.itemIndex,
          this.sliceTransformCustom
        )
      : sliceTransform().NullTransform;
  this.selectTransform =
    this.sliceSelectedTransformFunction !== null
      ? this.sliceSelectedTransformFunction(
          this.wheelnav.centerX,
          this.wheelnav.centerY,
          this.wheelnav.wheelRadius,
          this.baseAngle,
          ...
          this.titleRotateAngle,
          this.itemIndex,
          this.sliceSelectedTransformCustom
        )
      : sliceTransform().NullTransform;
  this.hoverTransform =
    this.sliceHoverTransformFunction !== null
      ? this.sliceHoverTransformFunction(
          this.wheelnav.centerX,
          this.wheelnav.centerY,
          this.wheelnav.wheelRadius,
          this.baseAngle,
          ...
          this.titleRotateAngle,
          this.itemIndex,
          this.sliceHoverTransformCustom
        )
      : sliceTransform().NullTransform;
  this.initTransform =
    this.sliceInitTransformFunction !== null
      ? this.sliceInitTransformFunction(
          ...
          this.titleRotateAngle,
          this.itemIndex,
          this.sliceInitTransformCustom
        )
      : sliceTransform().NullTransform;
  wheelnavTitle().isPathTitle(this.title)
  ...
  this.initNavTitle = initNavTitle.getTitlePercentAttr(
    this.sliceInitPath.titlePosX,
    this.sliceInitPath.titlePosY,
    this.titleWidth,
    this.titleHeight
  );
  this.basicNavTitleMin = basicNavTitleMin.getTitlePercentAttr(
    this.slicePathMin.titlePosX,
    this.slicePathMin.titlePosY,
    this.titleWidth,
    this.titleHeight
  );
  this.basicNavTitleMax = basicNavTitleMax.getTitlePercentAttr(
    this.slicePathMax.titlePosX,
    this.slicePathMax.titlePosY,
    this.titleWidth,
    this.titleHeight
  );
  this.hoverNavTitleMin = hoverNavTitleMin.getTitlePercentAttr(
    this.hoverSlicePathMin.titlePosX,
    this.hoverSlicePathMin.titlePosY,
    this.titleHoverWidth,
    this.titleHoverHeight
  );
  this.hoverNavTitleMax = hoverNavTitleMax.getTitlePercentAttr(
    this.hoverSlicePathMax.titlePosX,
    this.hoverSlicePathMax.titlePosY,
    this.titleHoverWidth,
    this.titleHoverHeight
  );
  this.selectedNavTitleMin = selectedNavTitleMin.getTitlePercentAttr(
    this.selectedSlicePathMin.titlePosX,
    this.selectedSlicePathMin.titlePosY,
    this.titleSelectedWidth,
    this.titleSelectedHeight
  );
  this.selectedNavTitleMax = selectedNavTitleMax.getTitlePercentAttr(
    this.selectedSlicePathMax.titlePosX,
    this.selectedSlicePathMax.titlePosY,
    this.titleSelectedWidth,
    this.titleSelectedHeight
  );
};
wheelnavItem.prototype.getCurrentPath = function () {
  return this.wheelnav.currentPercent === this.wheelnav.maxPercent
    ? this.selected
      ? this.selectedSlicePathMax
      : this.hovered
      ? this.hoverSlicePathMax
...
wheelnavItem.prototype.getCurrentTitle = function () {
  return this.wheelnav.currentPercent === this.wheelnav.maxPercent
    ? this.selected
      ? this.selectedNavTitleMax
      : this.hovered
      ? this.hoverNavTitleMax
      : this.basicNavTitleMax
    : this.selected
    ? this.selectedNavTitleMin
    : this.hovered
    ? this.hoverNavTitleMin
    : this.basicNavTitleMin;
};
...
wheelnavItem.prototype.getTitleRotateString = function (n) {
  var t = '';
  return (
    (t += this.getItemRotateString()),
    t +
      (this.titleRotateAngle !== null && n
        ? ',r,' + (this.navAngle + this.titleRotateAngle).toString()
        : ',r,' + (-this.currentRotateAngle).toString())
  );
};
wheelnavTitle = function (n, t) {
  ...
  return (
    (this.isPathTitle = function (n) {
      return n !== null &&
        (n.substr(0, 1) === 'm' || n.substr(0, 1) === 'M') &&
        (n.substr(n.length - 1, 1) === 'z' || n.substr(n.length - 1, 1) === 'Z') &&
...
wheelnavTitle.prototype.getTitlePercentAttr = function (n, t, i, r) {
  ...
  return (
    this.relativePath !== undefined
      ? ((f = n + (this.startX - this.centerX)),
        (e = t + (this.startY - this.centerY)),
        (this.relativePath[0][1] = f),
        (this.relativePath[0][2] = e),
        (u = { path: this.relativePath, title: this.title }))
      : (u = this.isImageTitle()
          ? { x: n - i / 2, y: t - r / 2, width: i, height: r, title: this.title, src: this.title.substr(7, this.title.length) }
          : { x: n, y: t, title: this.title }),
    u
  );
};
  ...
  return (
    n !== null &&
      ...
      this.height > this.width
        ? ((i += (n / this.height).toString() + ','), (i += (t / this.height).toString()))
        : ((i += (n / this.width).toString() + ','), (i += (t / this.width).toString()))),
    i
  );
};
wheelnav.prototype.styleWheel = function () {
  this.cssMode
    ...
    : ((this.spreaderPathInAttr === undefined || this.spreaderPathInAttr === null) &&
        (this.spreaderPathInAttr = { fill: '#444', stroke: '#444', 'stroke-width': 2, cursor: 'pointer' }),
      (this.spreaderPathOutAttr === undefined || this.spreaderPathOutAttr === null) &&
        (this.spreaderPathOutAttr = { fill: '#444', stroke: '#444', 'stroke-width': 2, cursor: 'pointer' }),
      (this.spreaderTitleInAttr === undefined || this.spreaderTitleInAttr === null) &&
        (this.spreaderTitleInAttr = { fill: '#eee', stroke: '#444', cursor: 'pointer' }),
      (this.spreaderTitleOutAttr === undefined || this.spreaderTitleOutAttr === null) &&
        (this.spreaderTitleOutAttr = { fill: '#eee', stroke: '#444', cursor: 'pointer' }),
      (this.markerAttr === undefined || this.markerAttr === null) && (this.markerAttr = { stroke: '#444', 'stroke-width': 2 }));
};
...
var pathHelper = function () {
    return (
      ...
      (this.navItemCount = 0),
      (this.navAngle = 0),
      (this.setBaseValue = function (n, t) {
        t === null ? (t = new slicePathCustomization()) : (this.custom = t);
        this.sliceRadius = this.wheelRadius * n * 0.9;
        ...
        t !== null
          ? (t.titleRadiusPercent !== null && (this.titleRadius = this.sliceRadius * t.titleRadiusPercent),
            t.titleSliceAnglePercent !== null &&
              (this.titleTheta = this.getTheta(this.startAngle + this.sliceAngle * t.titleSliceAnglePercent)))
          : ((this.titleRadius = this.sliceRadius * 0.5), (this.titleTheta = this.middleTheta));
        this.setTitlePos();
      }),
      ...
      (this.radians = function (n) {
        return (n * Math.PI) / 180;
      }),
      (this.degrees = function (n) {
...
slicePath = function () {
  return (
    (this.NullSlice = function (n, t, i) {
      return n.setBaseValue(t, i), { slicePathString: '', linePathString: '', titlePosX: n.titlePosX, titlePosY: n.titlePosY };
    }),
    (this.NullInitSlice = function (n, t, i) {
      return (
        n.setBaseValue(t, i),
        (slicePathString = [n.MoveToCenter(), n.Close()]),
        { slicePathString: slicePathString, linePathString: slicePathString, titlePosX: n.centerX, titlePosY: n.centerY }
      );
    }),
    (this.PieSliceCustomization = function () {
      var n = new slicePathCustomization();
      return (n.titleRadiusPercent = 0.6), (n.arcBaseRadiusPercent = 1), (n.arcRadiusPercent = 1), (n.startRadiusPercent = 0), n;
    }),
    (this.PieSlice = function (n, t, i) {
      ...
      return (
        (slicePathString = [
          n.MoveTo(n.middleAngle, i.startRadiusPercent * n.sliceRadius),
          n.LineTo(n.startAngle, r),
          n.ArcTo(u, n.middleAngle, r),
          n.ArcTo(u, n.endAngle, r),
          n.Close(),
        ]),
        { slicePathString: slicePathString, linePathString: '', titlePosX: n.titlePosX, titlePosY: n.titlePosY }
      );
    }),
    (this.FlowerSlice = function (n, t, i) {
      i === null &&
        ((i = PieSliceCustomization()), (i.titleRadiusPercent = 0.5), (i.arcBaseRadiusPercent = 0.65), (i.arcRadiusPercent = 0.14));
      var r = PieSlice(n, t, i);
      return { slicePathString: r.slicePathString, linePathString: '', titlePosX: r.titlePosX, titlePosY: r.titlePosY };
    }),
    (this.PieArrowSliceCustomization = function () {
      var n = new slicePathCustomization();
      return (n.titleRadiusPercent = 0.6), (n.arrowRadiusPercent = 1.1), n;
    }),
    (this.PieArrowSlice = function (n, t, i) {
      i === null && (i = PieArrowSliceCustomization());
      n.setBaseValue(t, i);
      r = n.sliceRadius;
      arrowAngleStart = n.startAngle + n.sliceAngle * 0.45;
      arrowAngleEnd = n.startAngle + n.sliceAngle * 0.55;
      var u = r * i.arrowRadiusPercent;
      return (
        (slicePathString = [
          n.MoveToCenter(),
          n.LineTo(n.startAngle, r),
          n.ArcTo(r, arrowAngleStart, r),
          n.LineTo(n.middleAngle, u),
          n.LineTo(arrowAngleEnd, r),
          n.ArcTo(r, n.endAngle, r),
          n.Close(),
        ]),
        { slicePathString: slicePathString, linePathString: '', titlePosX: n.titlePosX, titlePosY: n.titlePosY }
      );
    ...
    (this.DonutSliceCustomization = function () {
      var n = new slicePathCustomization();
      return (n.minRadiusPercent = 0.37), (n.maxRadiusPercent = 0.9), n;
    }),
    (this.DonutSlice = function (n, t, i) {
      return (
        i === null && (i = DonutSliceCustomization()),
        (maxRadius = n.wheelRadius * t * i.maxRadiusPercent),
        (minRadius = n.wheelRadius * t * i.minRadiusPercent),
        n.setBaseValue(t, i),
        (n.titleRadius = (maxRadius + minRadius) / 2),
        n.setTitlePos(),
        (slicePathString = [
          n.MoveTo(n.startAngle, minRadius),
          n.LineTo(n.startAngle, maxRadius),
          n.ArcTo(maxRadius, n.middleAngle, maxRadius),
          n.ArcTo(maxRadius, n.endAngle, maxRadius),
          n.LineTo(n.endAngle, minRadius),
          n.ArcBackTo(minRadius, n.middleAngle, minRadius),
          n.ArcBackTo(minRadius, n.startAngle, minRadius),
          n.Close(),
        ]),
        { slicePathString: slicePathString, linePathString: '', titlePosX: n.titlePosX, titlePosY: n.titlePosY }
      );
    ...
    (this.CogSliceCustomization = function () {
      var n = new slicePathCustomization();
      return (n.titleRadiusPercent = 0.55), (n.isBasePieSlice = !1), n;
    }),
    (this.CogSlice = function (n, t, i) {
      return (
        ...
        n.setBaseValue(t, i),
        (r = n.sliceRadius),
        (rbase = n.wheelRadius * t * 0.83),
        (percentAngle0625 = n.startAngle + n.sliceAngle * 0.0625),
        (percentAngle1250 = n.startAngle + n.sliceAngle * 0.125),
        (percentAngle1875 = n.startAngle + n.sliceAngle * 0.1875),
        (percentAngle2500 = n.startAngle + n.sliceAngle * 0.25),
        (percentAngle3125 = n.startAngle + n.sliceAngle * 0.3125),
        (percentAngle3750 = n.startAngle + n.sliceAngle * 0.375),
        (percentAngle4375 = n.startAngle + n.sliceAngle * 0.4375),
        (percentAngle5000 = n.startAngle + n.sliceAngle * 0.5),
        (percentAngle5625 = n.startAngle + n.sliceAngle * 0.5625),
        (percentAngle6250 = n.startAngle + n.sliceAngle * 0.625),
        (percentAngle6875 = n.startAngle + n.sliceAngle * 0.6875),
        (percentAngle7500 = n.startAngle + n.sliceAngle * 0.75),
        (percentAngle8125 = n.startAngle + n.sliceAngle * 0.8125),
        (percentAngle8750 = n.startAngle + n.sliceAngle * 0.875),
        (percentAngle9375 = n.startAngle + n.sliceAngle * 0.9375),
        (percentAngle9687 = n.startAngle + n.sliceAngle * 0.96875),
        i.isBasePieSlice
          ? ((r = rbase),
            (slicePathString = [
              n.MoveToCenter(),
              n.LineTo(n.startAngle, r),
              n.ArcTo(r, percentAngle0625, r),
              n.ArcTo(r, percentAngle1250, r),
              n.ArcTo(r, percentAngle1875, r),
              n.ArcTo(r, percentAngle2500, r),
              n.ArcTo(r, percentAngle3125, r),
              n.ArcTo(r, percentAngle3750, r),
              n.ArcTo(r, percentAngle4375, r),
              n.ArcTo(r, percentAngle5000, r),
              n.ArcTo(r, percentAngle5625, r),
              n.ArcTo(r, percentAngle6250, r),
              n.ArcTo(r, percentAngle6875, r),
              n.ArcTo(r, percentAngle7500, r),
              n.ArcTo(r, percentAngle8125, r),
              n.ArcTo(r, percentAngle8750, r),
              n.ArcTo(r, percentAngle9375, r),
              n.ArcTo(r, percentAngle9687, r),
              n.ArcTo(r, n.endAngle, r),
              n.Close(),
            ]))
          : (slicePathString = [
              ...
              n.LineTo(n.startAngle, r),
              n.ArcTo(r, percentAngle0625, r),
              n.LineTo(percentAngle0625, rbase),
              n.ArcTo(rbase, percentAngle1875, rbase),
              n.LineTo(percentAngle1875, r),
              n.ArcTo(r, percentAngle3125, r),
              n.LineTo(percentAngle3125, rbase),
              n.ArcTo(rbase, percentAngle4375, rbase),
              n.LineTo(percentAngle4375, r),
              n.ArcTo(r, percentAngle5625, r),
              n.LineTo(percentAngle5625, rbase),
              n.ArcTo(rbase, percentAngle6875, rbase),
              n.LineTo(percentAngle6875, r),
              n.ArcTo(r, percentAngle8125, r),
              n.LineTo(percentAngle8125, rbase),
              n.ArcTo(rbase, percentAngle9375, rbase),
              n.LineTo(percentAngle9375, r),
              n.ArcTo(r, n.endAngle, r),
              n.Close(),
            ]),
        { slicePathString: slicePathString, linePathString: '', titlePosX: n.titlePosX, titlePosY: n.titlePosY }
    ...
    (this.StarSliceCustomization = function () {
      var n = new slicePathCustomization();
      return (n.titleRadiusPercent = 0.44), (n.minRadiusPercent = 0.5), (n.isBasePieSlice = !1), n;
    }),
    (this.StarSlice = function (n, t, i) {
      return (
        ...
        n.setBaseValue(t, i),
        (r = n.wheelRadius * t),
        (rbase = r * i.minRadiusPercent),
        i.isBasePieSlice
          ? ((r = n.sliceRadius),
            (slicePathString = [
              n.MoveToCenter(),
              n.LineTo(n.startAngle, r),
              n.ArcTo(r, n.middleAngle, r),
              n.ArcTo(r, n.endAngle, r),
              n.Close(),
            ]))
          : (slicePathString = [
              n.MoveToCenter(),
              n.LineTo(n.startAngle, rbase),
              n.LineTo(n.middleAngle, r),
              n.LineTo(n.endAngle, rbase),
              n.Close(),
            ]),
        { slicePathString: slicePathString, linePathString: '', titlePosX: n.titlePosX, titlePosY: n.titlePosY }
      );
    ...
    (this.MenuSliceCustomization = function () {
      var n = new slicePathCustomization();
      return (n.menuRadius = 35), (n.titleRadiusPercent = 0.63), (n.isSelectedLine = !1), (n.lineBaseRadiusPercent = 0), n;
    }),
    (this.MenuSlice = function (n, t, i) {
      ...
      return (
        ...
        (y = n.centerY),
        (u = n.wheelRadius * t),
        (n.titleRadius = u * i.titleRadiusPercent),
        n.setTitlePos(),
        (r = t * i.menuRadius),
        t <= 0.05 && (r = 10),
        ...
        (linePathString =
          t <= 0.05
            ...
            : i.isSelectedLine
            ? [n.MoveTo(n.middleAngle, i.lineBaseRadiusPercent * u), n.ArcTo(u / 3, n.middleAngle, n.titleRadius - r)]
            : [n.MoveTo(n.middleAngle, i.lineBaseRadiusPercent * u), n.ArcTo(u / 2, n.middleAngle, n.titleRadius - r)]),
        { slicePathString: slicePathString, linePathString: linePathString, titlePosX: n.titlePosX, titlePosY: n.titlePosY }
      );
    }),
    (this.MenuSliceSelectedLine = function (n, t, i) {
      ...
      return { slicePathString: r.slicePathString, linePathString: r.linePathString, titlePosX: r.titlePosX, titlePosY: r.titlePosY };
    }),
    ...
    (this.LineSlice = function (n, t, i) {
      return (
        n.setBaseValue(t, i),
        (r = n.sliceRadius),
        n.sliceAngle > 60 && n.sliceAngle < 180
          ? ((n.titleRadius = r * (36 / n.sliceAngle)), n.setTitlePos())
          : ((n.titleRadius = r * 0.55), n.setTitlePos()),
        (slicePathString =
          n.sliceAngle < 180
            ? [n.MoveToCenter(), n.LineTo(n.startAngle, r), n.LineTo(n.endAngle, r), n.Close()]
            : n.startAngle === 180 || n.startAngle === 0 || n.startAngle === -180 || n.startAngle === 360
            ? [
                n.MoveToCenter(),
                n.LineTo(n.startAngle, r),
                n.LineTo(n.startAngle, r, n.middleAngle, r),
                n.LineTo(n.endAngle, r, n.middleAngle, r),
                n.LineTo(n.endAngle, r),
                n.Close(),
              ]
            : [
                n.MoveToCenter(),
                n.LineTo(n.startAngle, r),
                n.LineTo(n.middleAngle, r, n.startAngle, r),
                n.LineTo(n.middleAngle, r, n.endAngle, r),
                n.LineTo(n.endAngle, r),
                n.Close(),
              ]),
        { slicePathString: slicePathString, linePathString: '', titlePosX: n.titlePosX, titlePosY: n.titlePosY }
    ...
    (this.EyeSliceCustomization = function () {
      var n = new slicePathCustomization();
      return (n.titleRadiusPercent = 0.68), n;
    }),
    (this.EyeSlice = function (n, t, i) {
      return (
        i === null && (i = EyeSliceCustomization()),
        n.setBaseValue(t, i),
        (r = n.wheelRadius * t * 0.7),
        t === 0 && (r = 0.01),
        (startAngle = n.startAngle),
        (endAngle = n.endAngle),
        n.sliceAngle === 180 &&
          ((startAngle = n.startAngle + n.sliceAngle / 4), (endAngle = n.startAngle + n.sliceAngle - n.sliceAngle / 4)),
        (slicePathString = [n.MoveTo(endAngle, r), n.ArcTo(r, startAngle, r), n.ArcTo(r, endAngle, r), n.Close()]),
        { slicePathString: slicePathString, linePathString: '', titlePosX: n.titlePosX, titlePosY: n.titlePosY }
      );
    }),
    (this.WheelSlice = function (n, t, i) {
      ...
      return (
        n.sliceAngle < 120
          ? ((n.titleRadius = r * 0.57), (u = 0.9), (middleRadiusPercent = 0.87), (f = 0.87))
          : n.sliceAngle < 180
          ? ((n.titleRadius = r * 0.52), (u = 0.91), (middleRadiusPercent = 0.87), (f = 0.87))
          : ((n.titleRadius = r * 0.45), (u = 0.873), (middleRadiusPercent = 0.87), (f = 0.94)),
        (slicePathString = [
          n.MoveTo(n.middleAngle, r * 0.07),
          [
            'L',
            r * 0.07 * Math.cos(middleTheta) + r * f * Math.cos(startTheta) + x,
            r * 0.07 * Math.sin(middleTheta) + r * f * Math.sin(startTheta) + y,
          ],
          [
            'A',
            r * u,
            ...
            0,
            1,
            r * 0.07 * Math.cos(middleTheta) + r * middleRadiusPercent * Math.cos(middleTheta) + x,
            r * 0.07 * Math.sin(middleTheta) + r * middleRadiusPercent * Math.sin(middleTheta) + y,
          ],
          [
            'A',
            r * u,
            ...
            0,
            1,
            r * 0.07 * Math.cos(middleTheta) + r * f * Math.cos(endTheta) + x,
            r * 0.07 * Math.sin(middleTheta) + r * f * Math.sin(endTheta) + y,
          ],
          n.Close(),
        ]),
        (linePathString = [
          n.MoveTo(n.startAngle, r),
          n.ArcTo(r, n.middleAngle, r),
          n.ArcTo(r, n.endAngle, r),
          n.ArcBackTo(r, n.middleAngle, r),
          n.ArcBackTo(r, n.startAngle, r),
        ]),
        n.setTitlePos(),
        { slicePathString: slicePathString, linePathString: linePathString, titlePosX: n.titlePosX, titlePosY: n.titlePosY }
      );
    }),
    (this.OuterStrokeSlice = function (n, t, i) {
      return (
        n.setBaseValue(t, i),
        (x = n.centerX),
        (y = n.centerY),
        (r = n.sliceRadius),
        (innerRadius = r / 4),
        (n.titleRadius = n.sliceAngle < 120 ? r * 0.57 : n.sliceAngle < 180 ? r * 0.52 : r * 0.45),
        (linePathString = [
          n.MoveTo(n.startAngle, innerRadius),
          n.LineTo(n.startAngle, r),
          n.MoveTo(n.endAngle, innerRadius),
          n.LineTo(n.endAngle, r),
        ]),
        (slicePathString = [
          n.MoveTo(n.startAngle, r),
          ...
          n.ArcBackTo(r, n.startAngle, r),
          n.MoveTo(n.startAngle, innerRadius),
          n.ArcTo(innerRadius, n.middleAngle, innerRadius),
          n.ArcTo(innerRadius, n.endAngle, innerRadius),
          n.ArcBackTo(innerRadius, n.middleAngle, innerRadius),
          n.ArcBackTo(innerRadius, n.startAngle, innerRadius),
        ]),
        n.setTitlePos(),
        { slicePathString: slicePathString, linePathString: linePathString, titlePosX: n.titlePosX, titlePosY: n.titlePosY }
      );
    ...
    (this.TabSlice = function (n) {
      ...
      return (
        ...
        { slicePathString: slicePathString, linePathString: '', titlePosX: titlePosX, titlePosY: titlePosY }
      );
    }),
    (this.YinYangSlice = function (n, t, i) {
      return (
        ...
        (slicePathString = [
          n.MoveToCenter(),
          n.ArcTo(r / 2, n.startAngle, r),
          n.ArcTo(r, n.middleAngle, r),
          n.ArcTo(r, n.endAngle, r),
          n.ArcBackTo(r / 2, 0, 0),
          n.Close(),
        ]),
        (titlePosX = n.getX(n.startAngle, r / 2)),
        (titlePosY = n.getY(n.startAngle, r / 2)),
        { slicePathString: slicePathString, linePathString: slicePathString, titlePosX: titlePosX, titlePosY: titlePosY }
      );
    }),
    (this.WebSlice = function (n, t, i) {
      return (
        n.setBaseValue(t, i),
        (r = n.sliceRadius),
        (n.titleRadius = r * 0.55),
        n.setTitlePos(),
        (linePathString = [
          n.MoveToCenter(),
          n.LineTo(n.startAngle, r * 1.1),
          n.MoveToCenter(),
          n.LineTo(n.endAngle, r * 1.1),
          n.MoveTo(n.startAngle, r * 0.15),
          n.LineTo(n.endAngle, r * 0.15),
          n.MoveTo(n.startAngle, r * 0.35),
          n.LineTo(n.endAngle, r * 0.35),
          n.MoveTo(n.startAngle, r * 0.55),
          n.LineTo(n.endAngle, r * 0.55),
          n.MoveTo(n.startAngle, r * 0.75),
          n.LineTo(n.endAngle, r * 0.75),
          n.MoveTo(n.startAngle, r * 0.95),
          n.LineTo(n.endAngle, r * 0.95),
          n.Close(),
        ]),
        { slicePathString: '', linePathString: linePathString, titlePosX: n.titlePosX, titlePosY: n.titlePosY }
      );
    }),
    (this.WinterSliceCustomization = function () {
      var n = new slicePathCustomization();
      return (n.titleRadiusPercent = 0.85), (n.arcRadiusPercent = 1), n;
    }),
    (this.WinterSlice = function (n, t, i) {
      ...
      return (
        (slicePathString = [
          n.MoveToCenter(),
          n.MoveTo(parallelAngle, r / 100),
          n.LineTo(borderAngle1, r / 2),
          n.LineTo(parallelAngle, r - r / 100),
          n.LineTo(borderAngle2, r / 2),
          n.LineTo(parallelAngle, r / 100),
          n.MoveTo(parallelAngle2, r / 100),
          n.LineTo(borderAngle4, r / 2),
          n.LineTo(parallelAngle2, r - r / 100),
          n.LineTo(borderAngle3, r / 2),
          n.LineTo(parallelAngle2, r / 100),
          n.Close(),
        ]),
        (linePathString = [
          n.MoveTo(parallelAngle, r),
          n.LineTo(borderAngle2, r / 2),
          n.MoveTo(borderAngle3, r / 2),
          n.LineTo(parallelAngle2, r),
        ]),
        { slicePathString: slicePathString, linePathString: linePathString, titlePosX: n.titlePosX, titlePosY: n.titlePosY }
      );
    }),
    (this.TutorialSliceCustomization = function () {
      var n = new slicePathCustomization();
      return (n.titleRadiusPercent = 0.6), (n.isMoveTo = !1), (n.isLineTo = !1), (n.isArcTo = !1), (n.isArcBackTo = !1), n;
    }),
    (this.TutorialSlice = function (n, t, i) {
      return (
        i === null && (i = TutorialSliceCustomization()),
        n.setBaseValue(t, i),
        (slicePathString = []),
        slicePathString.push(n.MoveToCenter()),
        i.isMoveTo === !0 && slicePathString.push(n.MoveTo(n.middleAngle, n.sliceRadius / 4)),
        i.isLineTo && slicePathString.push(n.LineTo(n.startAngle, n.sliceRadius)),
        i.isArcTo && slicePathString.push(n.ArcTo(n.sliceRadius, n.middleAngle, n.sliceRadius)),
        i.isArcBackTo && slicePathString.push(n.ArcBackTo(n.sliceRadius, n.endAngle, n.sliceRadius)),
        slicePathString.push(n.Close()),
        (linePathString = [
          n.MoveToCenter(),
          n.LineTo(n.startAngle, n.sliceRadius),
          n.ArcTo(n.sliceRadius, n.middleAngle, n.sliceRadius),
          n.ArcTo(n.sliceRadius, n.endAngle, n.sliceRadius),
          n.Close(),
        ]),
        { slicePathString: slicePathString, linePathString: linePathString, titlePosX: n.titlePosX, titlePosY: n.titlePosY }
      );
...
sliceTransform = function () {
  ...
  return (
    (this.NullTransform = function () {
      return { sliceTransformString: '', lineTransformString: '', titleTransformString: '' };
    }),
    (this.MoveMiddleTransform = function (i, r, u, f, e, o, s) {
      var c, h, l, a;
      return (
        t(i, r, u, f, e, o, s),
        (c = 't' + ((u / 10) * Math.cos(middleTheta)).toString() + ',' + ((u / 10) * Math.sin(middleTheta)).toString()),
        o !== null ? (h = n(-o)) : ((l = f - s * e), (h = n(l + e / 2))),
        (a = 's1,r0,t' + ((u / 10) * Math.cos(h)).toString() + ',' + ((u / 10) * Math.sin(h)).toString()),
        { sliceTransformString: c, lineTransformString: c, titleTransformString: a }
      );
    }),
    (this.RotateTransform = function () {
      var n = 's1,r360';
      return { sliceTransformString: n, lineTransformString: n, titleTransformString: n };
    }),
    ...
    (this.RotateTitleTransform = function () {
      return { sliceTransformString: '', lineTransformString: '', titleTransformString: 's1,r360' };
    }),
    (this.ScaleTransform = function () {
      var n = 's1.2';
      return { sliceTransformString: n, lineTransformString: '', titleTransformString: n };
    }),
    (this.ScaleTitleTransform = function () {
      return { sliceTransformString: '', lineTransformString: '', titleTransformString: 's1.3' };
    }),
    ...
    (this.CustomTransform = function (n, t, i, r, u, f, e, o) {
      ...
      return { sliceTransformString: s, lineTransformString: s, titleTransformString: s };
    }),
    (this.CustomTitleTransform = function (n, t, i, r, u, f, e, o) {
      var s = o.scaleString + ',' + o.rotateString;
      return { sliceTransformString: '', lineTransformString: '', titleTransformString: s };
    }),
    this
  );
};
...
spreader = function (n) {
  ...
  if (((this.wheelnav = n), this.wheelnav.spreaderEnable)) {
    ...
    this.fontAttr =
      this.wheelnav.spreaderTitleFont !== null
        ? { font: this.wheelnav.spreaderTitleFont }
        : { font: '100 32px Impact, Charcoal, sans-serif' };
    this.spreaderPathIn = this.wheelnav.spreaderPathFunction(
      this.spreaderHelper,
      this.wheelnav.spreaderInPercent,
      this.wheelnav.spreaderPathCustom
    );
    this.spreaderPathOut = this.wheelnav.spreaderPathFunction(
      this.spreaderHelper,
      this.wheelnav.spreaderOutPercent,
      this.wheelnav.spreaderPathCustom
    );
    ...
    wheelnavTitle().isImageTitle(this.wheelnav.spreaderOutTitle) &&
      (this.inTitleWidth === null && (this.inTitleWidth = 32),
      this.inTitleHeight === null && (this.inTitleHeight = 32),
      this.outTitleWidth === null && (this.outTitleWidth = 32),
      this.outTitleHeight === null && (this.outTitleHeight = 32));
    inTitle = wheelnavTitle().isPathTitle(this.wheelnav.spreaderInTitle)
      ? new wheelnavTitle(this.wheelnav.spreaderInTitle, this.wheelnav.raphael.raphael)
      : new wheelnavTitle(this.wheelnav.spreaderInTitle);
    this.inTitleSizeTransform = inTitle.getTitleSizeTransform(this.inTitleWidth, this.inTitleHeight);
    this.inTitle = inTitle.getTitlePercentAttr(
      this.spreaderPathIn.titlePosX,
      this.spreaderPathIn.titlePosY,
      this.inTitleWidth,
      this.inTitleHeight
    );
    outTitle = wheelnavTitle().isPathTitle(this.wheelnav.spreaderOutTitle)
      ? new wheelnavTitle(this.wheelnav.spreaderOutTitle, this.wheelnav.raphael.raphael)
      : new wheelnavTitle(this.wheelnav.spreaderOutTitle);
    this.outTitleSizeTransform = outTitle.getTitleSizeTransform(this.outTitleWidth, this.outTitleHeight);
    this.outTitle = outTitle.getTitlePercentAttr(
      this.spreaderPathOut.titlePosX,
      this.spreaderPathOut.titlePosY,
      this.outTitleWidth,
      this.outTitleHeight
    );
    var r = this.outTitle,
    ...
    t.initPercent < t.maxPercent &&
      ((r = this.inTitle),
      (e = this.wheelnav.spreaderTitleInAttr),
      (u = this.inTitleWidth),
      (f = this.inTitleHeight),
      (o = this.inTitleSizeTransform));
    this.spreaderTitle = wheelnavTitle().isPathTitle(this.wheelnav.spreaderOutTitle)
      ? t.raphael.path(r.path)
      : wheelnavTitle().isImageTitle(this.wheelnav.spreaderOutTitle)
      ? this.wheelnav.raphael.image(r.src, i.titlePosX - u / 2, i.titlePosY - f / 2, u, f)
      : t.raphael.text(i.titlePosX, i.titlePosY, r.title);
    this.spreaderTitle.attr(this.fontAttr);
    this.spreaderTitle.attr(e);
    this.spreaderTitle.attr({ transform: o });
...
spreader.prototype.setCurrentTransform = function (n) {
  if (this.wheelnav.spreaderEnable) {
    if (n === undefined || n === !1) {
      currentPath =
        this.wheelnav.currentPercent > this.wheelnav.minPercent
          ? this.spreaderPathOut.spreaderPathString
          : this.spreaderPathIn.spreaderPathString;
      spreaderTransformAttr = { path: currentPath };
      this.spreaderPath.animate(spreaderTransformAttr, this.animatetime, this.animateeffect);
      var t, i, r;
      this.wheelnav.currentPercent === this.wheelnav.maxPercent
        ? ((t = this.outTitle),
          (i = this.wheelnav.spreaderTitleOutAttr),
          this.spreaderPath.attr(this.wheelnav.spreaderPathOutAttr),
          (r = this.outTitleSizeTransform))
        : ((t = this.inTitle),
          (i = this.wheelnav.spreaderTitleInAttr),
          this.spreaderPath.attr(this.wheelnav.spreaderPathInAttr),
          (r = this.inTitleSizeTransform));
      wheelnavTitle().isPathTitle(t.title)
        ? ((i.path = t.path), (i.transform = r))
        : wheelnavTitle().isImageTitle(t.title)
        ? ((i.x = t.x), (i.y = t.y), (i.width = t.width), (i.height = t.height), this.spreaderTitle.attr({ src: t.src }))
        : ((offYOffset = 0),
          t.title === '-' && (offYOffset = 3),
          (i.x = t.x),
          (i.y = t.y - offYOffset),
          t.title !== null && this.spreaderTitle.attr({ text: t.title }));
...
spreaderPath = function () {
  return (
    (this.NullSpreader = function (n, t) {
      return (
        t === null && (t = new spreaderPathCustomization()),
        n.setBaseValue(t.spreaderPercent, t),
        { spreaderPathString: '', titlePosX: n.titlePosX, titlePosY: n.titlePosY }
      );
    }),
    ...
    (this.PieSpreader = function (n, t, i) {
      ...
      return (
        (spreaderPathString = []),
        n.StartSpreader(spreaderPathString, n.startAngle, r),
        spreaderPathString.push(n.ArcTo(u, n.middleAngle, r)),
        spreaderPathString.push(n.ArcTo(u, n.endAngle, r)),
        spreaderPathString.push(n.Close()),
        { spreaderPathString: spreaderPathString, titlePosX: n.titlePosX, titlePosY: n.titlePosY }
      );
    }),
    (this.StarSpreaderCustomization = function () {
      var n = new spreaderPathCustomization();
      return (n.minRadiusPercent = 0.5), n;
    }),
    (this.StarSpreader = function (n, t, i) {
      ...
      for (var u = 0; u < n.navItemCount; u++)
        (startAngle = u * sliceAngle + (baseAngle + sliceAngle / 2)),
          (middleAngle = startAngle + sliceAngle / 2),
          (endAngle = startAngle + sliceAngle),
          n.endAngle - n.startAngle < 360 && u === n.navItemCount - 1 && (endAngle = middleAngle),
          spreaderPathString.push(n.LineTo(startAngle, rbase)),
          spreaderPathString.push(n.LineTo(middleAngle, r)),
          spreaderPathString.push(n.LineTo(endAngle, rbase));
      return spreaderPathString.push(n.Close()), { spreaderPathString: spreaderPathString, titlePosX: n.titlePosX, titlePosY: n.titlePosY };
    }),
    (this.AntiStarSpreaderCustomization = function () {
      var n = new spreaderPathCustomization();
      return (n.minRadiusPercent = 0.21), n;
    }),
    (this.AntiStarSpreader = function (n, t, i) {
      ...
      sliceAngle = n.sliceAngle / n.navItemCount;
      baseAngle = n.navAngle;
      n.endAngle - n.startAngle < 360
        ? ((baseAngle = n.startAngle), n.StartSpreader(spreaderPathString, baseAngle, rbase))
        : spreaderPathString.push(n.MoveTo(n.startAngle + (n.navAngle + sliceAngle / 2), rbase));
      for (var u = 0; u < n.navItemCount; u++)
        (startAngle = u * sliceAngle + (baseAngle + sliceAngle / 2)),
          (middleAngle = startAngle + sliceAngle / 2),
          (endAngle = startAngle + sliceAngle),
          n.endAngle - n.startAngle < 360 && u === n.navItemCount - 1 && (endAngle = middleAngle),
          spreaderPathString.push(n.LineTo(startAngle, r)),
          spreaderPathString.push(n.LineTo(middleAngle, rbase)),
          spreaderPathString.push(n.LineTo(endAngle, r));
      return spreaderPathString.push(n.Close()), { spreaderPathString: spreaderPathString, titlePosX: n.titlePosX, titlePosY: n.titlePosY };
    }),
    (this.FlowerSpreaderCustomization = function () {
      var n = new spreaderPathCustomization();
      return (n.minRadiusPercent = 0.63), (n.menuRadius = 7), n;
    }),
    (this.FlowerSpreader = function (n, t, i) {
      ...
      for (var u = 0; u < n.navItemCount; u++)
        (startAngle = u * sliceAngle + (baseAngle + sliceAngle / 2)),
          ...
          (endAngle = startAngle + sliceAngle),
          n.endAngle - n.startAngle < 360
            ? (u === 0 && spreaderPathString.push(n.ArcTo(i.menuRadius, startAngle, rbase)),
              u === n.navItemCount - 1 && (endAngle = middleAngle))
            : spreaderPathString.push(n.LineTo(startAngle, rbase)),
          spreaderPathString.push(n.ArcTo(i.menuRadius, endAngle, rbase));
      return spreaderPathString.push(n.Close()), { spreaderPathString: spreaderPathString, titlePosX: n.titlePosX, titlePosY: n.titlePosY };
    }),
    (this.HolderSpreaderCustomization = function () {
      var n = new spreaderPathCustomization();
      return (n.minRadiusPercent = 0.5), (n.menuRadius = 37), n;
    }),
      ...
      for (var u = 0; u < n.navItemCount; u++)
        (startAngle = u * sliceAngle + (baseAngle + sliceAngle / 2)),
          ...
          n.endAngle - n.startAngle < 360
            ...
            : spreaderPathString.push(n.LineTo(startAngle, rbase)),
          spreaderPathString.push(n.LineTo(startAngle, r)),
          spreaderPathString.push(n.ArcBackTo(i.menuRadius, middleAngle, rbase)),
          spreaderPathString.push(n.ArcTo(i.menuRadius, endAngle, r));
      return spreaderPathString.push(n.Close()), { spreaderPathString: spreaderPathString, titlePosX: n.titlePosX, titlePosY: n.titlePosY };
    }),
...
marker.prototype.setCurrentTransform = function (n) {
  ...
  this.wheelnav.markerEnable &&
    ...
    (t =
      this.wheelnav.currentPercent === this.wheelnav.maxPercent
        ? this.markerPathMax.markerPathString
        : this.markerPathMin.markerPathString),
    n !== undefined
      ? ((i = n - this.markerHelper.navAngle),
        (markerTransformAttr = { transform: 'r,' + i.toString() + ',' + this.wheelnav.centerX + ',' + this.wheelnav.centerY, path: t }))
      : (markerTransformAttr = { path: t }),
    this.marker.animate(markerTransformAttr, this.animatetime, this.animateeffect),
    this.marker.toFront());
};
markerPath = function () {
  return (
    (this.NullMarker = function (n, t) {
      return (
        t === null && (t = new markerPathCustomization()),
        n.setBaseValue(t),
        { markerPathString: '', titlePosX: n.titlePosX, titlePosY: n.titlePosY }
      );
    }),
    (this.TriangleMarkerCustomization = function () {
      var n = new markerPathCustomization();
      return (n.arcBaseRadiusPercent = 1.09), (n.arcRadiusPercent = 1.2), (n.startRadiusPercent = 0), n;
    }),
    (this.TriangleMarker = function (n, t, i) {
      ...
      var u = n.sliceRadius * i.arcBaseRadiusPercent,
        ...
        f = n.startAngle + n.sliceAngle * 0.46,
        e = n.startAngle + n.sliceAngle * 0.54;
      return (
        (markerPathString = [n.MoveTo(n.navAngle, u), n.LineTo(f, r), n.LineTo(e, r), n.Close()]),
        { markerPathString: markerPathString, titlePosX: n.titlePosX, titlePosY: n.titlePosY }
      );
    }),
    ...
    (this.PieLineMarker = function (n, t, i) {
      ...
      var r = n.sliceRadius * i.arcBaseRadiusPercent,
        u = n.sliceRadius * i.arcRadiusPercent;
      return (
        i.sliceAngle !== null && ((n.startAngle = n.navAngle - i.sliceAngle / 2), (n.endAngle = n.navAngle + i.sliceAngle / 2)),
        (markerPathString = [n.MoveTo(n.startAngle, r), n.ArcTo(u, n.endAngle, r), n.ArcBackTo(u, n.startAngle, r), n.Close()]),
        { markerPathString: markerPathString, titlePosX: n.titlePosX, titlePosY: n.titlePosY }
      );
    }),
    (this.MenuMarkerCustomization = function () {
      var n = new markerPathCustomization();
      return (n.menuRadius = 40), (n.titleRadiusPercent = 0.63), (n.lineBaseRadiusPercent = 0), n;
    }),
    ...
    (this.LineMarker = function (n, t, i) {
      ...
      var r = n.sliceRadius * i.arcBaseRadiusPercent,
        u = n.sliceRadius * i.arcRadiusPercent;
      return (
        (markerPathString = [n.MoveTo(n.navAngle, r), n.LineTo(n.navAngle, u), n.Close()]),
        { markerPathString: markerPathString, titlePosX: n.titlePosX, titlePosY: n.titlePosY }
      );
    }),
    (this.DropMarkerCustomization = function () {
      var n = new markerPathCustomization();
      return (n.dropBaseRadiusPercent = 0), (n.dropRadiusPercent = 0.15), n;
    }),
    (this.DropMarker = function (n, t, i) {
      i === null && (i = DropMarkerCustomization());
      n.setBaseValue(i.markerPercent * t, i);
      var u = n.sliceRadius * i.dropBaseRadiusPercent,
        f = n.startAngle + n.sliceAngle * 0.2,
        e = n.startAngle,
        o = n.startAngle + n.sliceAngle * 0.8,
      ...
      return (
        (markerPathString = [
          ...
          n.ArcTo(r, 180, r),
          n.ArcTo(r, 360, r),
          n.MoveTo(n.navAngle, u),
          n.LineTo(f, r),
          n.LineTo(e, r),
          n.LineTo(n.navAngle, r * 1.6),
          n.LineTo(s, r),
          n.LineTo(o, r),
          n.Close(),
        ]),
