...
Config.MaxJob = 1 -- 🛸 maximum number of cars that can be rented while having a job 🛸

Config.DistanseSpawn = 5.0 -- 🗺 the distance at which the car will spawn 🗺
Config.DistanseLock = 2.0 -- 🔒 the distance at which the car will be closed 🔒
