...
-- Dumping structure for table fixall.businesses
...
-- Dumping data for table fixall.businesses: ~2 rows (approximately)
...
INSERT INTO `businesses` (`id`, `name`, `address`, `description`, `blipname`, `owner`, `price`, `earnings`, `position`, `stock`, `stock_price`, `employees`, `taxrate`) VALUES
	(1, 'Gucci Store', 'Some random street 1337, Beverly Hills', 'Very fancy store', NULL, 'steam:110000134a401f0', 1000000, 10000, '{"buy":{"x":2524.11, "y":-382.22, "z":93},"actions":{"x":2526.04,"y":-379.43,"z":92.99}}', 55, 100, '{}', NULL),
	(2, 'Gucci Store 2', 'Some random street 1338, Beverly Hills', 'Very fancy store', NULL, NULL, 1333337, 1337, '{"buy":{"x":0.0,"y":0.0,"z":0.0},"actions":{"x":0.0,"y":0.0,"z":0.0}}', 0, 100, '{}', NULL);
...
-- Dumping data for table fixall.items: ~84 rows (approximately)
