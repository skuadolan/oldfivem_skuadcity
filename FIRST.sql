...
INSERT INTO `addon_account` (`name`, `label`, `shared`) VALUES
	...
	('motels_bed_black_money', 'Uang Kotor Motel Bed', 0),
	('motels_black_money', 'Uang Kotor Motel', 0),
	('property_black_money', 'Agen Properti', 0),
	('society_ambulance', 'EMS', 1),
	('society_biker', 'Biker', 1),
	('society_biker_black_money', 'Uang Kotor Biker', 1),
	('society_cardealer', 'Cardealer', 1),
	('society_cartel', 'Cartel', 1),
	('society_cartel_black_money', 'Uang Kotor Cartel', 1),
	('society_gang', 'Gangster', 1),
	('society_gang_black_money', 'Uang Kotor Gangster', 1),
	('society_mafia', 'Mafia', 1),
	('society_mafia_black_money', 'Uang Kotor Mafia', 1),
	('society_mechanic', 'Mekanik', 1),
	('society_pedagang', 'Pedagang', 1),
	('society_police', 'Polisi', 1),
	('society_police_black_money', 'Uang Kotor Polisi', 1),
...
-- Dumping data for table fixall.datastore: ~24 rows (approximately)
...
-- Dumping structure for table fixall.disc_ammo
...
-- Dumping data for table fixall.disc_ammo: ~0 rows (approximately)
/*!40000 ALTER TABLE `disc_ammo` DISABLE KEYS */;
/*!40000 ALTER TABLE `disc_ammo` ENABLE KEYS */;

-- Dumping structure for table fixall.doors
...
-- Dumping data for table fixall.doors: ~0 rows (approximately)
...
-- Dumping data for table fixall.items: ~70 rows (approximately)
/*!40000 ALTER TABLE `items` DISABLE KEYS */;
INSERT INTO `items` (`name`, `label`, `weight`, `limit`, `rare`, `can_remove`, `price`) VALUES
	('air_putih', 'Air Mineral', 1, 45, 0, 1, 3000),
	('alive_chicken', 'Ayam Hidup', 1, 20, 0, 1, 0),
	('armor', 'Armor', 1, 4, 0, 1, 0),
	('bandage', 'Perban', 1, 10, 0, 1, 1500),
	('beer', 'Bir', 1, 10, 0, 1, 0),
	('blackmoney', 'Uang Kotor', 1, 10, 0, 1, 0),
	('blowpipe', 'Las', 1, 10, 0, 1, 0),
	('carokit', 'Dempul Mobil', 1, 10, 0, 1, 1500),
	('carotool', 'Perkakas', 1, 10, 0, 1, 0),
	('cashmoney', 'Uang', 1, 10, 0, 1, 0),
	('clip', 'Ammo', 1, 10, 0, 1, 100000),
	('clothe', 'Baju', 1, 40, 0, 1, 0),
	('coklat', 'Coklat', 1, 45, 0, 1, 3000),
	('copper', 'Tembaga', 1, 56, 0, 1, 0),
	('crack', 'Crack', 1, 10, 0, 1, 0),
	('cutted_wood', 'Kayu Potong', 1, 20, 0, 1, 0),
	('dabs', 'Dabs', 1, 10, 0, 1, 0),
	('diamond', 'Berlian', 1, 50, 0, 1, 0),
	('drugtest', 'Test Narkoba', 1, 10, 0, 1, 0),
	('ephedra', 'Ephedra', 1, 10, 0, 1, 0),
	('ephedrine', 'Ephedrine', 1, 10, 0, 1, 0),
	('essence', 'Minyak Siap Jual', 1, 24, 0, 1, 0),
	('fabric', 'Kain', 1, 80, 0, 1, 0),
	('fish', 'Ikan', 1, 10, 0, 1, 0),
	('fixkit', 'Alat Perbaikan', 1, 10, 0, 1, 1500),
	('fixtool', 'Peralatan Perbaikan', 1, 10, 0, 1, 0),
	('gazbottle', 'Botol Gas', 1, 10, 0, 1, 0),
	('gold', 'Emas', 1, 21, 0, 1, 0),
	('gym_membership', 'Kartu Mambership GYM', 1, 10, 0, 1, 0),
	('iron', 'Besi', 1, 42, 0, 1, 0),
	('jewels', 'Permata', 1, 10, 0, 1, 0),
	('kecubung', 'Kecubung', 1, 90, 0, 1, 0),
	('kopi', 'Kopi', 1, 45, 0, 1, 3000),
	('lisensi_senjata', 'Lisensi Senjata', 1, 1, 0, 1, 0),
	('makaroni', 'Makaroni', 1, 45, 0, 1, 3000),
	('medikit', 'Kotak P3K', 1, 10, 0, 1, 1500),
	('micin', 'Micin', 1, 90, 0, 1, 0),
	('moneywash', 'Lisensi Cuci Uang', 1, 1, 0, 1, 0),
	('moneywashid', 'Tiket Cuci Uang', 1, 10, 0, 1, 0),
	('narcan', 'Narcan', 1, 10, 0, 1, 0),
	('nasi_bungkus', 'Nasi Bungkus', 1, 45, 0, 1, 3000),
	('nasi_goreng', 'Nasi Goreng', 1, 45, 0, 1, 3000),
	('packaged_chicken', 'Ayam Siap Jual', 1, 100, 0, 1, 0),
	('packaged_plank', 'Papan Siap Jual', 1, 100, 0, 1, 0),
	('painkiller', 'Painkiller', 1, 10, 0, 1, 0),
	('pcp', 'PCP', 1, 10, 0, 1, 0),
	('petrol', 'Minyak Mentah', 1, 24, 0, 1, 0),
	('petrol_raffin', 'Minyak Bersih', 1, 24, 0, 1, 0),
	('phone', 'Handphone', 1, 10, 0, -1, 10000),
	('pkecubung', 'Paket Kecubung', 1, 30, 0, 1, 0),
	('pmicin', 'Paket Micin', 1, 30, 0, 1, 0),
	('powerade', 'Power F', 1, 10, 0, 1, 0),
	('psianida', 'Paket Sianida', 1, 90, 0, 1, 0),
	('radio', 'Radio', 1, 10, 0, -1, 15000),
	('repairkit', 'Peralatan ', 1, 10, 0, 1, 1500),
	('sianida', 'Sianida', 1, 90, 0, 1, 0),
	('siomay', 'Siomay', 1, 45, 0, 1, 3000),
	('slaughtered_chicken', 'Ayam Potong', 1, 20, 0, 1, 0),
	('sportlunch', 'Sportlunch', 1, 10, 0, 1, 0),
	('stone', 'Batu', 1, 7, 0, 1, 0),
	('susu', 'Susu', 1, 45, 0, 1, 3000),
	('tacos', 'Taco', 1, 10, 0, 1, 0),
	('teh', 'Teh', 1, 45, 0, 1, 3000),
	('tehkotak', 'Teh Kotak', 1, 45, 0, 1, 3000),
	('vegetables', 'Sayuran', 1, 10, 0, 1, 0),
...
-- Dumping data for table fixall.jobs: ~24 rows (approximately)
...
-- Dumping data for table fixall.job_grades: ~111 rows (approximately)
/*!40000 ALTER TABLE `job_grades` DISABLE KEYS */;
INSERT INTO `job_grades` (`job_name`, `grade`, `name`, `label`, `salary`, `skin_male`, `skin_female`) VALUES
	('unemployed', 0, 'unemployed', 'Pengangguran', 1500, '{}', '{}'),
	('cardealer', 0, 'recruit', 'Recruit', 2500, '{}', '{}'),
	('cardealer', 1, 'novice', 'Novice', 5000, '{}', '{}'),
	('cardealer', 2, 'experienced', 'Experienced', 7500, '{}', '{}'),
	('cardealer', 3, 'boss', 'Boss', 10000, '{}', '{}'),
	('ambulance', 0, 'asisten_perawat', 'Asisten Perawat', 3000, '{}', '{}'),
	('ambulance', 1, 'perawat', 'Perawat', 6000, '{"tshirt_2":0,"hair_color_1":5,"glasses_2":3,"shoes":42,"torso_2":0,"hair_color_2":0,"pants_1":24,"glasses_1":4,"hair_1":2,"sex":0,"decals_2":0,"tshirt_1":15,"helmet_1":8,"helmet_2":0,"arms":85,"face":19,"decals_1":57,"torso_1":249,"hair_2":0,"skin":34,"pants_2":5}', '{"tshirt_2":3,"decals_2":0,"glasses":0,"hair_1":2,"torso_1":73,"shoes":1,"hair_color_2":0,"glasses_1":19,"skin":13,"face":6,"pants_2":5,"tshirt_1":75,"pants_1":37,"helmet_1":57,"torso_2":0,"arms":14,"sex":1,"glasses_2":0,"decals_1":0,"hair_2":0,"helmet_2":0,"hair_color_1":0}'),
	('ambulance', 2, 'asisten_doctor', 'Asisten Dokter', 9000, '{"tshirt_2":3,"hair_color_1":5,"glasses_2":3,"shoes":42,"torso_2":1,"hair_color_2":0,"pants_1":24,"glasses_1":4,"hair_1":2,"sex":0,"decals_2":0,"tshirt_1":63,"helmet_1":8,"helmet_2":0,"arms":86,"face":19,"decals_1":57,"torso_1":140,"hair_2":0,"skin":34,"pants_2":5}', '{"tshirt_2":3,"decals_2":0,"glasses":0,"hair_1":2,"torso_1":73,"shoes":1,"hair_color_2":0,"glasses_1":19,"skin":13,"face":6,"pants_2":5,"tshirt_1":75,"pants_1":37,"helmet_1":57,"torso_2":0,"arms":14,"sex":1,"glasses_2":0,"decals_1":0,"hair_2":0,"helmet_2":0,"hair_color_1":0}'),
	('ambulance', 3, 'chief_doctor', 'Dokter', 12000, '{}', '{}'),
	('ambulance', 4, 'asisten_boss', 'Wakil Direktur', 15000, '{"tshirt_2":1,"hair_color_1":5,"glasses_2":3,"shoes":65,"shoes_2":3,"chain_2":3,"chain_2":3,"torso_2":1,"hair_color_2":0,"pants_1":52,"glasses_1":4,"hair_1":2,"sex":0,"decals_2":0,"tshirt_1":34,"helmet_1":8,"helmet_2":0,"arms":86,"face":19,"decals_1":57,"torso_1":101,"hair_2":0,"skin":34,"pants_2":0}', '{"tshirt_2":3,"decals_2":0,"glasses":0,"hair_1":2,"torso_1":73,"shoes":1,"hair_color_2":0,"glasses_1":19,"skin":13,"face":6,"pants_2":5,"tshirt_1":75,"pants_1":37,"helmet_1":57,"torso_2":0,"arms":14,"sex":1,"glasses_2":0,"decals_1":0,"hair_2":0,"helmet_2":0,"hair_color_1":0}'),
	('ambulance', 5, 'boss', 'Direktur', 18000, '{}', '{}'),
	('mechanic', 0, 'recrue', 'Magang', 8000, '{"tshirt_2":0,"hair_color_1":5,"glasses_2":1,"shoes":71,"torso_2":0,"hair_color_2":0,"pants_1":39,"glasses_1":5,"hair_1":2,"sex":0,"decals_2":0,"tshirt_1":15,"helmet_1":-1,"helmet_2":0,"arms":53,"face":19,"decals_1":0,"torso_1":66,"hair_2":0,"skin":34,"pants_2":0}', '{}'),
	('mechanic', 1, 'novice', 'Amatir', 7000, '{"tshirt_2":0,"hair_color_1":5,"glasses_2":1,"shoes":71,"torso_2":1,"hair_color_2":0,"pants_1":39,"glasses_1":5,"hair_1":2,"sex":0,"decals_2":0,"tshirt_1":15,"helmet_1":-1,"helmet_2":0,"arms":53,"face":19,"decals_1":0,"torso_1":66,"hair_2":0,"skin":34,"pants_2":1}', '{}'),
	('mechanic', 2, 'experimente', 'Ahli', 8000, '{"tshirt_2":0,"hair_color_1":5,"glasses_2":1,"shoes":71,"torso_2":2,"hair_color_2":0,"pants_1":39,"glasses_1":5,"hair_1":2,"sex":0,"decals_2":0,"tshirt_1":15,"helmet_1":-1,"helmet_2":0,"arms":53,"face":19,"decals_1":0,"torso_1":66,"hair_2":0,"skin":34,"pants_2":2}', '{}'),
	('mechanic', 3, 'chief', 'Wakil Bos', 9000, '{"tshirt_2":0,"hair_color_1":5,"glasses_2":1,"shoes":48,"torso_2":15,"hair_color_2":0,"pants_1":91,"glasses_1":5,"hair_1":2,"sex":0,"decals_2":0,"tshirt_1":15,"helmet_1":-1,"helmet_2":0,"arms":31,"face":19,"decals_1":0,"torso_1":248,"hair_2":0,"skin":34,"pants_2":0}', '{}'),
	('mechanic', 4, 'boss', 'Bos', 10000, '{"tshirt_2":0,"hair_color_1":5,"glasses_2":1,"shoes":48,"torso_2":15,"hair_color_2":0,"pants_1":91,"glasses_1":5,"hair_1":2,"sex":0,"decals_2":0,"tshirt_1":15,"helmet_1":-1,"helmet_2":0,"arms":31,"face":19,"decals_1":0,"torso_1":248,"hair_2":0,"skin":34,"pants_2":0}', '{}'),
	...
	('taxi', 1, 'novice', 'Novice', 6000, '{"hair_2":0,"hair_color_2":0,"torso_1":32,"bags_1":0,"helmet_2":0,"chain_2":0,"eyebrows_3":0,"makeup_3":0,"makeup_2":0,"tshirt_1":31,"makeup_1":0,"bags_2":0,"makeup_4":0,"eyebrows_4":0,"chain_1":0,"lipstick_4":0,"bproof_2":0,"hair_color_1":0,"decals_2":0,"pants_2":0,"age_2":0,"glasses_2":0,"ears_2":0,"arms":27,"lipstick_1":0,"ears_1":-1,"mask_2":0,"sex":0,"lipstick_3":0,"helmet_1":-1,"shoes_2":0,"beard_2":0,"beard_1":0,"lipstick_2":0,"beard_4":0,"glasses_1":0,"bproof_1":0,"mask_1":0,"decals_1":1,"hair_1":0,"eyebrows_2":0,"beard_3":0,"age_1":0,"tshirt_2":0,"skin":0,"torso_2":0,"eyebrows_1":0,"face":0,"shoes_1":10,"pants_1":24}', '{"hair_2":0,"hair_color_2":0,"torso_1":57,"bags_1":0,"helmet_2":0,"chain_2":0,"eyebrows_3":0,"makeup_3":0,"makeup_2":0,"tshirt_1":38,"makeup_1":0,"bags_2":0,"makeup_4":0,"eyebrows_4":0,"chain_1":0,"lipstick_4":0,"bproof_2":0,"hair_color_1":0,"decals_2":0,"pants_2":1,"age_2":0,"glasses_2":0,"ears_2":0,"arms":21,"lipstick_1":0,"ears_1":-1,"mask_2":0,"sex":1,"lipstick_3":0,"helmet_1":-1,"shoes_2":0,"beard_2":0,"beard_1":0,"lipstick_2":0,"beard_4":0,"glasses_1":5,"bproof_1":0,"mask_1":0,"decals_1":1,"hair_1":0,"eyebrows_2":0,"beard_3":0,"age_1":0,"tshirt_2":0,"skin":0,"torso_2":0,"eyebrows_1":0,"face":0,"shoes_1":49,"pants_1":11}'),
	...
	('taxi', 3, 'uber', 'Uber', 12000, '{"hair_2":0,"hair_color_2":0,"torso_1":26,"bags_1":0,"helmet_2":0,"chain_2":0,"eyebrows_3":0,"makeup_3":0,"makeup_2":0,"tshirt_1":57,"makeup_1":0,"bags_2":0,"makeup_4":0,"eyebrows_4":0,"chain_1":0,"lipstick_4":0,"bproof_2":0,"hair_color_1":0,"decals_2":0,"pants_2":4,"age_2":0,"glasses_2":0,"ears_2":0,"arms":11,"lipstick_1":0,"ears_1":-1,"mask_2":0,"sex":0,"lipstick_3":0,"helmet_1":-1,"shoes_2":0,"beard_2":0,"beard_1":0,"lipstick_2":0,"beard_4":0,"glasses_1":0,"bproof_1":0,"mask_1":0,"decals_1":0,"hair_1":0,"eyebrows_2":0,"beard_3":0,"age_1":0,"tshirt_2":0,"skin":0,"torso_2":0,"eyebrows_1":0,"face":0,"shoes_1":10,"pants_1":24}', '{"hair_2":0,"hair_color_2":0,"torso_1":57,"bags_1":0,"helmet_2":0,"chain_2":0,"eyebrows_3":0,"makeup_3":0,"makeup_2":0,"tshirt_1":38,"makeup_1":0,"bags_2":0,"makeup_4":0,"eyebrows_4":0,"chain_1":0,"lipstick_4":0,"bproof_2":0,"hair_color_1":0,"decals_2":0,"pants_2":1,"age_2":0,"glasses_2":0,"ears_2":0,"arms":21,"lipstick_1":0,"ears_1":-1,"mask_2":0,"sex":1,"lipstick_3":0,"helmet_1":-1,"shoes_2":0,"beard_2":0,"beard_1":0,"lipstick_2":0,"beard_4":0,"glasses_1":5,"bproof_1":0,"mask_1":0,"decals_1":1,"hair_1":0,"eyebrows_2":0,"beard_3":0,"age_1":0,"tshirt_2":0,"skin":0,"torso_2":0,"eyebrows_1":0,"face":0,"shoes_1":49,"pants_1":11}'),
	...
	('pedagang', 0, 'karyawan', 'Karyawan', 4500, '{}', '{}'),
	('pedagang', 1, 'wakil_boss', 'Manajer', 7500, '{}', '{}'),
	('pedagang', 2, 'boss', 'Bos', 10000, '{}', '{}'),
	('police', 0, 'tamtama', 'Tamtama', 5000, '{}', '{}'),
	('police', 1, 'bripda', 'Bripda', 6000, '{}', '{}'),
	('police', 2, 'briptu', 'Briptu', 7000, '{}', '{}'),
	('police', 3, 'brigpol', 'Brigpol', 8000, '{}', '{}'),
	('police', 4, 'bripka', 'Bripka', 9000, '{}', '{}'),
	('police', 5, 'aipda', 'Aipda', 10000, '{}', '{}'),
	('police', 6, 'aiptu', 'Aiptu', 11000, '{}', '{}'),
	('police', 7, 'ipda', 'Ipda', 12000, '{}', '{}'),
	('police', 8, 'iptu', 'Iptu', 13000, '{}', '{}'),
	('police', 9, 'akp', 'Akp', 14000, '{}', '{}'),
	('police', 10, 'kompol', 'Kompol', 15000, '{}', '{}'),
	('police', 11, 'akbp', 'Akbp', 16000, '{}', '{}'),
	('police', 12, 'brigjen', 'Brigjen', 17000, '{}', '{}'),
	('police', 13, 'irjen', 'Irjen', 18000, '{}', '{}'),
	('police', 14, 'komjen', 'Komjen', 19000, '{}', '{}'),
	('police', 15, 'boss', 'Jendral', 20000, '{}', '{}'),
	('biker', 0, 'recruit', 'Anggota', 1500, '{}', '{}'),
	('biker', 1, 'officer', 'Bodyguard', 1500, '{}', '{}'),
	('biker', 2, 'sergeant', 'Penasihat', 1500, '{}', '{}'),
	('biker', 3, 'lieutenant', 'Wakil Ketua', 1500, '{}', '{}'),
	('biker', 4, 'boss', 'Ketua', 1500, '{}', '{}'),
	('cartel', 0, 'recruit', 'Anggota', 1500, '{}', '{}'),
	('cartel', 1, 'officer', 'Bodyguard', 1500, '{}', '{}'),
	('cartel', 2, 'sergeant', 'Penasihat', 1500, '{}', '{}'),
	('cartel', 3, 'lieutenant', 'Wakil Ketua', 1500, '{}', '{}'),
	('cartel', 4, 'boss', 'Ketua', 1500, '{}', '{}'),
	('gang', 0, 'recruit', 'Anggota', 1500, '{}', '{}'),
	('gang', 1, 'officer', 'Bodyguard', 1500, '{}', '{}'),
	('gang', 2, 'sergeant', 'Penasihat', 1500, '{}', '{}'),
	('gang', 3, 'lieutenant', 'Wakil Ketua', 1500, '{}', '{}'),
	('gang', 4, 'boss', 'Ketua', 1500, '{}', '{}'),
	('mafia', 0, 'recruit', 'Anggota', 1500, '{}', '{}'),
	('mafia', 1, 'officer', 'Bodyguard', 1500, '{}', '{}'),
	('mafia', 2, 'sergeant', 'Penasihat', 1500, '{}', '{}'),
	('mafia', 3, 'lieutenant', 'Wakil Ketua', 1500, '{}', '{}'),
	('mafia', 4, 'boss', 'Ketua', 1500, '{}', '{}'),
	('theb', 0, 'recruit', 'magang', 1500, '{}', '{}'),
	('theb', 1, 'officer', 'anggota', 1500, '{}', '{}'),
	('theb', 2, 'sergeant', 'bodyguard', 1500, '{}', '{}'),
	('theb', 3, 'lieutenant', 'wakil ketua', 1500, '{}', '{}'),
	('theb', 4, 'boss', 'ketua', 1500, '{}', '{}'),
	('lumberjack', 0, 'employed', 'Amatir', 3000, '{"tshirt_1":15, "torso_1":61, "arms":27, "pants_1":9, "shoes_1":12, "helmet_1":20}', '{}'),
	('fisherman', 0, 'employed', 'Amatir', 3000, '{"tshirt_1":15, "torso_1":9, "arms":30, "pants_1": 15, "shoes_1":16, "helmet_1":20}', '{}'),
	('fueler', 0, 'employed', 'Amatir', 3000, '{"tshirt_1":15, "torso_1":44, "torso_2":3, "arms":30, "pants_1": 15, "shoes_1":12, "shoes_2":6, "helmet_1":20}', '{}'),
	('tailor', 0, 'employed', 'Amatir', 3000, '{"mask_1":0,"arms":1,"glasses_1":0,"hair_color_2":4,"makeup_1":0,"face":19,"glasses":0,"mask_2":0,"makeup_3":0,"skin":29,"helmet_2":0,"lipstick_4":0,"sex":0,"torso_1":24,"makeup_2":0,"bags_2":0,"chain_2":0,"ears_1":-1,"bags_1":0,"bproof_1":0,"shoes_2":0,"lipstick_2":0,"chain_1":0,"tshirt_1":0,"eyebrows_3":0,"pants_2":0,"beard_4":0,"torso_2":0,"beard_2":6,"ears_2":0,"hair_2":0,"shoes_1":36,"tshirt_2":0,"beard_3":0,"hair_1":2,"hair_color_1":0,"pants_1":48,"helmet_1":-1,"bproof_2":0,"eyebrows_4":0,"eyebrows_2":0,"decals_1":0,"age_2":0,"beard_1":5,"shoes":10,"lipstick_1":0,"eyebrows_1":0,"glasses_2":0,"makeup_4":0,"decals_2":0,"lipstick_3":0,"age_1":0}', '{"mask_1":0,"arms":5,"glasses_1":5,"hair_color_2":4,"makeup_1":0,"face":19,"glasses":0,"mask_2":0,"makeup_3":0,"skin":29,"helmet_2":0,"lipstick_4":0,"sex":1,"torso_1":52,"makeup_2":0,"bags_2":0,"chain_2":0,"ears_1":-1,"bags_1":0,"bproof_1":0,"shoes_2":1,"lipstick_2":0,"chain_1":0,"tshirt_1":23,"eyebrows_3":0,"pants_2":0,"beard_4":0,"torso_2":0,"beard_2":6,"ears_2":0,"hair_2":0,"shoes_1":42,"tshirt_2":4,"beard_3":0,"hair_1":2,"hair_color_1":0,"pants_1":36,"helmet_1":-1,"bproof_2":0,"eyebrows_4":0,"eyebrows_2":0,"decals_1":0,"age_2":0,"beard_1":5,"shoes":10,"lipstick_1":0,"eyebrows_1":0,"glasses_2":0,"makeup_4":0,"decals_2":0,"lipstick_3":0,"age_1":0}'),
	('miner', 0, 'employed', 'Amatir', 3000, '{"tshirt_2":1,"ears_1":8,"glasses_1":15,"torso_2":0,"ears_2":2,"glasses_2":3,"shoes_2":1,"pants_1":75,"shoes_1":51,"bags_1":0,"helmet_2":0,"pants_2":7,"torso_1":71,"tshirt_1":59,"arms":2,"bags_2":0,"helmet_1":0}', '{}'),
	('slaughterer', 0, 'employed', 'Amatir', 3000, '{"age_1":0,"glasses_2":0,"beard_1":5,"decals_2":0,"beard_4":0,"shoes_2":0,"tshirt_2":0,"lipstick_2":0,"hair_2":0,"arms":67,"pants_1":36,"skin":29,"eyebrows_2":0,"shoes":10,"helmet_1":-1,"lipstick_1":0,"helmet_2":0,"hair_color_1":0,"glasses":0,"makeup_4":0,"makeup_1":0,"hair_1":2,"bproof_1":0,"bags_1":0,"mask_1":0,"lipstick_3":0,"chain_1":0,"eyebrows_4":0,"sex":0,"torso_1":56,"beard_2":6,"shoes_1":12,"decals_1":0,"face":19,"lipstick_4":0,"tshirt_1":15,"mask_2":0,"age_2":0,"eyebrows_3":0,"chain_2":0,"glasses_1":0,"ears_1":-1,"bags_2":0,"ears_2":0,"torso_2":0,"bproof_2":0,"makeup_2":0,"eyebrows_1":0,"makeup_3":0,"pants_2":0,"beard_3":0,"hair_color_2":4}', '{"age_1":0,"glasses_2":0,"beard_1":5,"decals_2":0,"beard_4":0,"shoes_2":0,"tshirt_2":0,"lipstick_2":0,"hair_2":0,"arms":72,"pants_1":45,"skin":29,"eyebrows_2":0,"shoes":10,"helmet_1":-1,"lipstick_1":0,"helmet_2":0,"hair_color_1":0,"glasses":0,"makeup_4":0,"makeup_1":0,"hair_1":2,"bproof_1":0,"bags_1":0,"mask_1":0,"lipstick_3":0,"chain_1":0,"eyebrows_4":0,"sex":1,"torso_1":49,"beard_2":6,"shoes_1":24,"decals_1":0,"face":19,"lipstick_4":0,"tshirt_1":9,"mask_2":0,"age_2":0,"eyebrows_3":0,"chain_2":0,"glasses_1":5,"ears_1":-1,"bags_2":0,"ears_2":0,"torso_2":0,"bproof_2":0,"makeup_2":0,"eyebrows_1":0,"makeup_3":0,"pants_2":0,"beard_3":0,"hair_color_2":4}'),
	('reporter', 1, 'employed', 'Amatir', 3000, '{}', '{}'),
	('offcardealer', 0, 'recruit', 'Recruit', 2500, '{}', '{}'),
	('offcardealer', 1, 'novice', 'Novice', 5000, '{}', '{}'),
	('offcardealer', 2, 'experienced', 'Experienced', 7500, '{}', '{}'),
	('offcardealer', 3, 'boss', 'Boss', 10000, '{}', '{}'),
	('offambulance', 0, 'asisten_perawat', 'Asisten Perawat', 3000, '{}', '{}'),
	('offambulance', 1, 'perawat', 'Perawat', 6000, '{}', '{}'),
	('offambulance', 2, 'asisten_doctor', 'Asisten Dokter', 9000, '{}', '{}'),
	('offambulance', 3, 'chief_doctor', 'Dokter', 12000, '{}', '{}'),
	('offambulance', 4, 'asisten_boss', 'Wakil Direktur', 15000, '{}', '{}'),
	('offambulance', 5, 'boss', 'Direktur', 18000, '{}', '{}'),
	('offmechanic', 0, 'recrue', 'Magang', 8000, '{}', '{}'),
	('offmechanic', 1, 'novice', 'Amatir', 7000, '{}', '{}'),
	('offmechanic', 2, 'experimente', 'Ahli', 8000, '{}', '{}'),
	('offmechanic', 3, 'chief', 'Wakil Bos', 9000, '{}', '{}'),
	('offmechanic', 4, 'boss', 'Bos', 10000, '{}', '{}'),
	('offtaxi', 0, 'recrue', 'Recrue', 3000, '{}', '{}'),
	('offtaxi', 1, 'novice', 'Novice', 6000, '{}', '{}'),
	('offtaxi', 2, 'experimente', 'Experimente', 9000, '{}', '{}'),
	('offtaxi', 3, 'uber', 'Uber', 12000, '{}', '{}'),
	('offtaxi', 4, 'boss', 'Patron', 15000, '{}', '{}'),
	('offpedagang', 0, 'karyawan', 'Karyawan', 4500, '{}', '{}'),
	('offpedagang', 1, 'wakil_boss', 'Manajer', 7500, '{}', '{}'),
	('offpedagang', 2, 'boss', 'Bos', 10000, '{}', '{}'),
	('offpolice', 0, 'tamtama', 'Tamtama', 5000, '{}', '{}'),
	('offpolice', 1, 'bripda', 'Bripda', 6000, '{}', '{}'),
	('offpolice', 2, 'briptu', 'Briptu', 7000, '{}', '{}'),
	('offpolice', 3, 'brigpol', 'Brigpol', 8000, '{}', '{}'),
	('offpolice', 4, 'bripka', 'Bripka', 9000, '{}', '{}'),
	('offpolice', 5, 'aipda', 'Aipda', 10000, '{}', '{}'),
	('offpolice', 6, 'aiptu', 'Aiptu', 11000, '{}', '{}'),
	('offpolice', 7, 'ipda', 'Ipda', 12000, '{}', '{}'),
	('offpolice', 8, 'iptu', 'Iptu', 13000, '{}', '{}'),
	('offpolice', 9, 'akp', 'Akp', 14000, '{}', '{}'),
	('offpolice', 10, 'kompol', 'Kompol', 15000, '{}', '{}'),
	('offpolice', 11, 'akbp', 'Akbp', 16000, '{}', '{}'),
	('offpolice', 12, 'brigjen', 'Brigjen', 17000, '{}', '{}'),
	('offpolice', 13, 'irjen', 'Irjen', 18000, '{}', '{}'),
	('offpolice', 14, 'komjen', 'Komjen', 19000, '{}', '{}'),
	('offpolice', 15, 'boss', 'Jendral', 20000, '{}', '{}');
...
-- Dumping structure for table fixall.lsrp_motels
...
-- Dumping data for table fixall.lsrp_motels: ~0 rows (approximately)
/*!40000 ALTER TABLE `lsrp_motels` DISABLE KEYS */;
/*!40000 ALTER TABLE `lsrp_motels` ENABLE KEYS */;

-- Dumping structure for table fixall.owned_motels
CREATE TABLE IF NOT EXISTS `owned_motels` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Dumping data for table fixall.owned_motels: ~0 rows (approximately)
/*!40000 ALTER TABLE `owned_motels` DISABLE KEYS */;
/*!40000 ALTER TABLE `owned_motels` ENABLE KEYS */;
...
-- Dumping data for table fixall.shops: ~9 rows (approximately)
/*!40000 ALTER TABLE `shops` DISABLE KEYS */;
INSERT INTO `shops` (`id`, `store`, `item`, `price`) VALUES
	(1, 'TwentyFourSeven', 'roti', 3000),
	(2, 'TwentyFourSeven', 'air_putih', 3000),
	(3, 'RobsLiquor', 'roti', 3000),
	(4, 'RobsLiquor', 'air_putih', 3000),
	(5, 'LTDgasoline', 'roti', 3000),
	(6, 'LTDgasoline', 'air_putih', 3000),
	(7, 'TwentyFourSeven', 'beer', 20000),
	(8, 'RobsLiquor', 'beer', 20000),
	(9, 'LTDgasoline', 'beer', 20000);
...
-- Dumping data for table fixall.vehicles_import: ~82 rows (approximately)
...
INSERT INTO `vehicles_import` (`name`, `model`, `price`, `category`) VALUES
	...
	('2017 Lamborghini Aventador S', '18performante', 4567800, 'importcars'),
	...
	('BMW S1000RR', 'bs17', 1352000, 'importmotorcycles'),
	...
	('Honda Civic', 'fk8', 1364500, 'importcars'),
	...
	('Nissan Skyline R-32', 'majsr', 2365400, 'importcars'),
	...
	('Nissan R35', 'r35', 2465700, 'importcars'),
	...
	('Lamborghini Sian 2012', 'sian', 5356400, 'importcars'),
	...
	('Toyota Supra 2019', 'supra19', 1236400, 'importcars'),
